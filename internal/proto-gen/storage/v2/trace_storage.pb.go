...
type Pagination struct {
	...
	// a new search. The value is the storage backend's own opaque cursor, in whatever
	// form the backend resumes from, and is not required to be text; a caller MUST
	// echo back exactly what the backend returned without inspecting or modifying it.
	// A token is only valid for the query that produced it.
	//
	// This field is optional.
...
func (m *Pagination) GetPageToken() []byte {
	if m != nil {
		return m.PageToken
	}
	return nil
...
type FindSpansResponse struct {
	...
	// page is the last one. The value is the storage backend's own opaque cursor, in
	// whatever form the backend resumes from, and is not required to be text.
...
func (m *FindSpansResponse) GetNextPageToken() []byte {
	if m != nil {
...
type FindTraceIDsResponse struct {
	...
	// to fetch the page after this one, see comments for Pagination. The value is the
	// storage backend's own opaque cursor, in whatever form the backend resumes from,
	// and is not required to be text. The backend leaves it empty when this is the
	// last page.
...
func (m *FindTraceIDsResponse) GetNextPageToken() []byte {
	if m != nil {
		return m.NextPageToken
	}
	return nil
...
type FindTraceSummariesResponse struct {
	...
	// to fetch the page after this one, see comments for Pagination. The value is the
	// storage backend's own opaque cursor, in whatever form the backend resumes from,
	// and is not required to be text. The backend sets it only on the final chunk of
	// the stream, and leaves it empty there when this is the last page.
	NextPageToken        []byte   `protobuf:"bytes,3,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *FindTraceSummariesResponse) GetNextPageToken() []byte {
	if m != nil {
		return m.NextPageToken
	}
	return nil
...
var fileDescriptor_3441c0fd9397413c = []byte{
	...
	,
}
