...
// WriteDbSpan provides a mock function for the type CoreSpanWriter
func (_mock *CoreSpanWriter) WriteDbSpan(ctx context.Context, span *dbmodel.Span) error {
	ret := _mock.Called(ctx, span)

	if len(ret) == 0 {
		panic("no return value specified for WriteDbSpan")
	}
...
// CoreSpanWriter_WriteDbSpan_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WriteDbSpan'
type CoreSpanWriter_WriteDbSpan_Call struct {
	*mock.Call
}

// WriteDbSpan is a helper method to define mock.On call
//   - ctx context.Context
//   - span *dbmodel.Span
func (_e *CoreSpanWriter_Expecter) WriteDbSpan(ctx interface{}, span interface{}) *CoreSpanWriter_WriteDbSpan_Call {
	return &CoreSpanWriter_WriteDbSpan_Call{Call: _e.mock.On("WriteDbSpan", ctx, span)}
}

func (_c *CoreSpanWriter_WriteDbSpan_Call) Run(run func(ctx context.Context, span *dbmodel.Span)) *CoreSpanWriter_WriteDbSpan_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *CoreSpanWriter_WriteDbSpan_Call) Return(err error) *CoreSpanWriter_WriteDbSpan_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *CoreSpanWriter_WriteDbSpan_Call) RunAndReturn(run func(ctx context.Context, span *dbmodel.Span) error) *CoreSpanWriter_WriteDbSpan_Call {
	_c.Call.Return(run)
	return _c
}
