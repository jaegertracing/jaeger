...
func (mb *MappingBuilder) SpanDataStreamMappings() (string, error) {
	...
	if !ok {
		return "", errors.New("span mapping is missing the 'mappings.properties' object")
	}
...
// there; the @custom-based migration alias is a later concern and is not needed
// for the fresh-install write path.
