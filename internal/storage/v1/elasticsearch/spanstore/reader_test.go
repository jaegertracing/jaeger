...
func returnSearchFunc(typ string, r *spanReaderTest) (any, error) {
	...
	case traceIDAggregation:
		return r.reader.spanReader.findTraceIDs(context.Background(), &spanstore.TraceQueryParameters{})
	}
...
func TestSpanReader_buildFindTraceIDsQuery(t *testing.T) {
	withSpanReader(t, func(r *spanReaderTest) {
		...
		actualQuery := r.reader.spanReader.buildFindTraceIDsQuery(traceQuery)
