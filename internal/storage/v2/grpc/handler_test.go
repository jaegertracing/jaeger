...
// TestHandler_GetCapabilities covers what the server makes of the reader it fronts. The
// ErrUnsupported case is the reason this maps rather than forwards: a reader that cannot
// determine its own capabilities must reach the client as UNIMPLEMENTED, which the client
// reads as "unknown", not as a backend declaring nothing (RFC 0013 §3.6).
