...
// NewSummaryReader creates a new instance of SummaryReader. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSummaryReader(t interface {
	mock.TestingT
	Cleanup(func())
}) *SummaryReader {
	mock := &SummaryReader{}
...
// SummaryReader is an autogenerated mock type for the SummaryReader type
type SummaryReader struct {
	mock.Mock
}

type SummaryReader_Expecter struct {
	mock *mock.Mock
}

func (_m *SummaryReader) EXPECT() *SummaryReader_Expecter {
	return &SummaryReader_Expecter{mock: &_m.Mock}
}
...
type SummaryReader_FindTraceSummaries_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - query tracestore.TraceQueryParams
func (_e *SummaryReader_Expecter) FindTraceSummaries(ctx interface{}, query interface{}) *SummaryReader_FindTraceSummaries_Call {
	return &SummaryReader_FindTraceSummaries_Call{Call: _e.mock.On("FindTraceSummaries", ctx, query)}
}

func (_c *SummaryReader_FindTraceSummaries_Call) Run(run func(ctx context.Context, query tracestore.TraceQueryParams)) *SummaryReader_FindTraceSummaries_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
