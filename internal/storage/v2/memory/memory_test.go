...
func TestFindTraces_OTLPFields(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:           "Filter by otel.scope.name=my-scope",
			queryAttrs:     map[string]string{"otel.scope.name": "my-scope"},
			expectedTraces: 1,
			expectedIDs:    []pcommon.TraceID{traceID1},
		},
		{
			name:           "Filter by otel.scope.name=other-scope",
			queryAttrs:     map[string]string{"otel.scope.name": "other-scope"},
			expectedTraces: 1,
			expectedIDs:    []pcommon.TraceID{traceID2},
		},
		{
			name:           "Filter by otel.scope.name (no match)",
			queryAttrs:     map[string]string{"otel.scope.name": "nonexistent"},
			expectedTraces: 0,
			expectedIDs:    []pcommon.TraceID{},
		},
		{
			name:           "Filter by otel.scope.version=1.0.0",
			queryAttrs:     map[string]string{"otel.scope.version": "1.0.0"},
			expectedTraces: 1,
			expectedIDs:    []pcommon.TraceID{traceID1},
		},
		{
			name:           "Filter by otel.scope.version=2.0.0",
			queryAttrs:     map[string]string{"otel.scope.version": "2.0.0"},
			expectedTraces: 1,
			expectedIDs:    []pcommon.TraceID{traceID2},
		},
		{
			name:           "Filter by otel.scope.version (no match)",
			queryAttrs:     map[string]string{"otel.scope.version": "99.0.0"},
			expectedTraces: 0,
			expectedIDs:    []pcommon.TraceID{},
		},
		{
		...
		{
			name:           "Combined: otel.scope.name AND otel.scope.version",
			queryAttrs:     map[string]string{"otel.scope.name": "my-scope", "otel.scope.version": "1.0.0"},
			expectedTraces: 1,
			expectedIDs:    []pcommon.TraceID{traceID1},
		},
		{
