...
var (
	_ = featuregate.GlobalRegistry().MustRegister(
		...
		featuregate.WithRegisterDescription("No-op: ClickHouse is always available as a storage backend and is selected through configuration. "+
			"Retained for backward compatibility and removed in v2.23.0."),
