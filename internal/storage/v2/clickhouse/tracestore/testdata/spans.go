...
var SingleSpan = []SpanRow{
	{
		...
		BytesAttributeKeys:    []string{"request_body"},
		BytesAttributeValues:  []string{"eyJuYW1lIjoidGVzdCJ9"},
...
var MultipleSpans = []SpanRow{
	...
	},
	{
		...
		BytesAttributeKeys:    []string{"db.query_plan"},
		BytesAttributeValues:  []string{"UExBTiBTRUxFQ1Q="},
