...
var singleSpan = []*dbmodel.SpanRow{
	{
		...
		Attributes: dbmodel.Attributes{
			...
			ComplexValues: []string{
				...
				"eyJrdmxpc3RWYWx1ZSI6eyJ2YWx1ZXMiOlt7ImtleSI6ImtleTEiLCJ2YWx1ZSI6eyJzdHJpbmdWYWx1ZSI6InZhbHVlMSJ9fSx7ImtleSI6ImtleTIiLCJ2YWx1ZSI6eyJzdHJpbmdWYWx1ZSI6InZhbHVlMiJ9fV19fQ==",
