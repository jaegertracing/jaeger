...
// RemoveSpansTTL removes the TTL from the spans table.
const RemoveSpansTTL = `ALTER TABLE spans REMOVE TTL`

// RemoveTraceIDTimestampsTTL removes the TTL from the trace_id_timestamps table.
const RemoveTraceIDTimestampsTTL = `ALTER TABLE trace_id_timestamps REMOVE TTL`
