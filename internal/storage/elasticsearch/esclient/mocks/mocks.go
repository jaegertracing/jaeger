...
// Close provides a mock function for the type BulkWriter
func (_mock *BulkWriter) Close() error {
	ret := _mock.Called()
...
// BulkWriter_Close_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Close'
type BulkWriter_Close_Call struct {
	*mock.Call
}

// Close is a helper method to define mock.On call
func (_e *BulkWriter_Expecter) Close() *BulkWriter_Close_Call {
	return &BulkWriter_Close_Call{Call: _e.mock.On("Close")}
}

func (_c *BulkWriter_Close_Call) Run(run func()) *BulkWriter_Close_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *BulkWriter_Close_Call) Return(err error) *BulkWriter_Close_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *BulkWriter_Close_Call) RunAndReturn(run func() error) *BulkWriter_Close_Call {
	_c.Call.Return(run)
	return _c
}
