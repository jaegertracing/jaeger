...
// GetTemplateMappings provides a mock function for the type Client
func (_mock *Client) GetTemplateMappings(name string) elasticsearch.IndicesGetTemplateMappingService {
	ret := _mock.Called(name)

	if len(ret) == 0 {
		panic("no return value specified for GetTemplateMappings")
	}

	var r0 elasticsearch.IndicesGetTemplateMappingService
	if returnFunc, ok := ret.Get(0).(func(string) elasticsearch.IndicesGetTemplateMappingService); ok {
		r0 = returnFunc(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.IndicesGetTemplateMappingService)
		}
	}
	return r0
}

// Client_GetTemplateMappings_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTemplateMappings'
type Client_GetTemplateMappings_Call struct {
	*mock.Call
}

// GetTemplateMappings is a helper method to define mock.On call
//   - name string
func (_e *Client_Expecter) GetTemplateMappings(name interface{}) *Client_GetTemplateMappings_Call {
	return &Client_GetTemplateMappings_Call{Call: _e.mock.On("GetTemplateMappings", name)}
}

func (_c *Client_GetTemplateMappings_Call) Run(run func(name string)) *Client_GetTemplateMappings_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *Client_GetTemplateMappings_Call) Return(indicesGetTemplateMappingService elasticsearch.IndicesGetTemplateMappingService) *Client_GetTemplateMappings_Call {
	_c.Call.Return(indicesGetTemplateMappingService)
	return _c
}

func (_c *Client_GetTemplateMappings_Call) RunAndReturn(run func(name string) elasticsearch.IndicesGetTemplateMappingService) *Client_GetTemplateMappings_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewIndicesGetTemplateMappingService creates a new instance of IndicesGetTemplateMappingService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIndicesGetTemplateMappingService(t interface {
	mock.TestingT
	Cleanup(func())
}) *IndicesGetTemplateMappingService {
	mock := &IndicesGetTemplateMappingService{}
	mock.Mock.Test(t)
...
// IndicesGetTemplateMappingService is an autogenerated mock type for the IndicesGetTemplateMappingService type
type IndicesGetTemplateMappingService struct {
	mock.Mock
}

type IndicesGetTemplateMappingService_Expecter struct {
	mock *mock.Mock
}

func (_m *IndicesGetTemplateMappingService) EXPECT() *IndicesGetTemplateMappingService_Expecter {
	return &IndicesGetTemplateMappingService_Expecter{mock: &_m.Mock}
}

// Do provides a mock function for the type IndicesGetTemplateMappingService
func (_mock *IndicesGetTemplateMappingService) Do(ctx context.Context) (map[string]any, error) {
	ret := _mock.Called(ctx)
...
// IndicesGetTemplateMappingService_Do_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Do'
type IndicesGetTemplateMappingService_Do_Call struct {
	*mock.Call
}

// Do is a helper method to define mock.On call
//   - ctx context.Context
func (_e *IndicesGetTemplateMappingService_Expecter) Do(ctx interface{}) *IndicesGetTemplateMappingService_Do_Call {
	return &IndicesGetTemplateMappingService_Do_Call{Call: _e.mock.On("Do", ctx)}
}

func (_c *IndicesGetTemplateMappingService_Do_Call) Run(run func(ctx context.Context)) *IndicesGetTemplateMappingService_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *IndicesGetTemplateMappingService_Do_Call) Return(stringToV map[string]any, err error) *IndicesGetTemplateMappingService_Do_Call {
	_c.Call.Return(stringToV, err)
	return _c
}

func (_c *IndicesGetTemplateMappingService_Do_Call) RunAndReturn(run func(ctx context.Context) (map[string]any, error)) *IndicesGetTemplateMappingService_Do_Call {
	_c.Call.Return(run)
	return _c
}
