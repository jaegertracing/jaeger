...
// Bulk provides a mock function for the type Client
func (_mock *Client) Bulk() elasticsearch.BulkService {
	ret := _mock.Called()
	...
	var r0 elasticsearch.BulkService
	if returnFunc, ok := ret.Get(0).(func() elasticsearch.BulkService); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.BulkService)
		}
	}
	return r0
}

// Client_Bulk_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Bulk'
type Client_Bulk_Call struct {
	*mock.Call
}

// Bulk is a helper method to define mock.On call
func (_e *Client_Expecter) Bulk() *Client_Bulk_Call {
	return &Client_Bulk_Call{Call: _e.mock.On("Bulk")}
}

func (_c *Client_Bulk_Call) Run(run func()) *Client_Bulk_Call {
...
func (_c *Client_Bulk_Call) Return(bulkService elasticsearch.BulkService) *Client_Bulk_Call {
	_c.Call.Return(bulkService)
	return _c
}

func (_c *Client_Bulk_Call) RunAndReturn(run func() elasticsearch.BulkService) *Client_Bulk_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewBulkService creates a new instance of BulkService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewBulkService(t interface {
	mock.TestingT
	Cleanup(func())
}) *BulkService {
	mock := &BulkService{}
...
// BulkService is an autogenerated mock type for the BulkService type
type BulkService struct {
	mock.Mock
}

type BulkService_Expecter struct {
	mock *mock.Mock
}

func (_m *BulkService) EXPECT() *BulkService_Expecter {
	return &BulkService_Expecter{mock: &_m.Mock}
}

// Add provides a mock function for the type BulkService
func (_mock *BulkService) Add(index string, typ string, body any) elasticsearch.BulkService {
	ret := _mock.Called(index, typ, body)
	...
	var r0 elasticsearch.BulkService
	if returnFunc, ok := ret.Get(0).(func(string, string, any) elasticsearch.BulkService); ok {
		r0 = returnFunc(index, typ, body)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.BulkService)
		}
...
// BulkService_Add_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Add'
type BulkService_Add_Call struct {
	*mock.Call
}
...
//   - typ string
//   - body any
func (_e *BulkService_Expecter) Add(index interface{}, typ interface{}, body interface{}) *BulkService_Add_Call {
	return &BulkService_Add_Call{Call: _e.mock.On("Add", index, typ, body)}
}

func (_c *BulkService_Add_Call) Run(run func(index string, typ string, body any)) *BulkService_Add_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *BulkService_Add_Call) Return(bulkService elasticsearch.BulkService) *BulkService_Add_Call {
	_c.Call.Return(bulkService)
	return _c
}

func (_c *BulkService_Add_Call) RunAndReturn(run func(index string, typ string, body any) elasticsearch.BulkService) *BulkService_Add_Call {
	_c.Call.Return(run)
	return _c
}

// Do provides a mock function for the type BulkService
func (_mock *BulkService) Do(ctx context.Context) (*elastic.BulkResponse, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (*elastic.BulkResponse, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) *elastic.BulkResponse); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
...
// BulkService_Do_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Do'
type BulkService_Do_Call struct {
	*mock.Call
}

// Do is a helper method to define mock.On call
//   - ctx context.Context
func (_e *BulkService_Expecter) Do(ctx interface{}) *BulkService_Do_Call {
	return &BulkService_Do_Call{Call: _e.mock.On("Do", ctx)}
}

func (_c *BulkService_Do_Call) Run(run func(ctx context.Context)) *BulkService_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *BulkService_Do_Call) Return(bulkResponse *elastic.BulkResponse, err error) *BulkService_Do_Call {
	_c.Call.Return(bulkResponse, err)
	return _c
}

func (_c *BulkService_Do_Call) RunAndReturn(run func(ctx context.Context) (*elastic.BulkResponse, error)) *BulkService_Do_Call {
	_c.Call.Return(run)
	return _c
}
