...
func (_mock *Client) GetTemplate(names ...string) elasticsearch.IndicesGetTemplateService {
	...
	var r0 elasticsearch.IndicesGetTemplateService
	if returnFunc, ok := ret.Get(0).(func(...string) elasticsearch.IndicesGetTemplateService); ok {
		r0 = returnFunc(names...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.IndicesGetTemplateService)
		}
	}
	return r0
}
...
//   - names ...string
func (_e *Client_Expecter) GetTemplate(names ...interface{}) *Client_GetTemplate_Call {
	return &Client_GetTemplate_Call{Call: _e.mock.On("GetTemplate",
		append([]interface{}{}, names...)...)}
}

func (_c *Client_GetTemplate_Call) Run(run func(names ...string)) *Client_GetTemplate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []string
...
func (_c *Client_GetTemplate_Call) Return(indicesGetTemplateService elasticsearch.IndicesGetTemplateService) *Client_GetTemplate_Call {
	_c.Call.Return(indicesGetTemplateService)
	return _c
}

func (_c *Client_GetTemplate_Call) RunAndReturn(run func(names ...string) elasticsearch.IndicesGetTemplateService) *Client_GetTemplate_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewIndicesGetTemplateService creates a new instance of IndicesGetTemplateService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIndicesGetTemplateService(t interface {
	mock.TestingT
	Cleanup(func())
}) *IndicesGetTemplateService {
	mock := &IndicesGetTemplateService{}
	mock.Mock.Test(t)
...
// IndicesGetTemplateService is an autogenerated mock type for the IndicesGetTemplateService type
type IndicesGetTemplateService struct {
	mock.Mock
}

type IndicesGetTemplateService_Expecter struct {
	mock *mock.Mock
}

func (_m *IndicesGetTemplateService) EXPECT() *IndicesGetTemplateService_Expecter {
	return &IndicesGetTemplateService_Expecter{mock: &_m.Mock}
}

// Do provides a mock function for the type IndicesGetTemplateService
func (_mock *IndicesGetTemplateService) Do(ctx context.Context) (map[string]*elastic.IndicesGetTemplateResponse, error) {
	ret := _mock.Called(ctx)
	...
	var r0 map[string]*elastic.IndicesGetTemplateResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (map[string]*elastic.IndicesGetTemplateResponse, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) map[string]*elastic.IndicesGetTemplateResponse); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*elastic.IndicesGetTemplateResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context) error); ok {
		r1 = returnFunc(ctx)
...
// IndicesGetTemplateService_Do_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Do'
type IndicesGetTemplateService_Do_Call struct {
	*mock.Call
}

// Do is a helper method to define mock.On call
//   - ctx context.Context
func (_e *IndicesGetTemplateService_Expecter) Do(ctx interface{}) *IndicesGetTemplateService_Do_Call {
	return &IndicesGetTemplateService_Do_Call{Call: _e.mock.On("Do", ctx)}
}

func (_c *IndicesGetTemplateService_Do_Call) Run(run func(ctx context.Context)) *IndicesGetTemplateService_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *IndicesGetTemplateService_Do_Call) Return(stringToIndicesGetTemplateResponse map[string]*elastic.IndicesGetTemplateResponse, err error) *IndicesGetTemplateService_Do_Call {
	_c.Call.Return(stringToIndicesGetTemplateResponse, err)
	return _c
}

func (_c *IndicesGetTemplateService_Do_Call) RunAndReturn(run func(ctx context.Context) (map[string]*elastic.IndicesGetTemplateResponse, error)) *IndicesGetTemplateService_Do_Call {
	_c.Call.Return(run)
	return _c
}
