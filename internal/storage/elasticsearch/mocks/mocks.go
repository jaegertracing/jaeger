...
// GetTemplate provides a mock function for the type Client
func (_mock *Client) GetTemplate(name string) elasticsearch.IndicesGetIndexTemplateService {
	...
	var r0 elasticsearch.IndicesGetIndexTemplateService
	if returnFunc, ok := ret.Get(0).(func(string) elasticsearch.IndicesGetIndexTemplateService); ok {
		r0 = returnFunc(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.IndicesGetIndexTemplateService)
		}
	}
	return r0
}

// Client_GetTemplate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTemplate'
type Client_GetTemplate_Call struct {
	*mock.Call
}

// GetTemplate is a helper method to define mock.On call
//   - name string
func (_e *Client_Expecter) GetTemplate(name interface{}) *Client_GetTemplate_Call {
	return &Client_GetTemplate_Call{Call: _e.mock.On("GetTemplate", name)}
}

func (_c *Client_GetTemplate_Call) Run(run func(name string)) *Client_GetTemplate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *Client_GetTemplate_Call) Return(indicesGetIndexTemplateService elasticsearch.IndicesGetIndexTemplateService) *Client_GetTemplate_Call {
	_c.Call.Return(indicesGetIndexTemplateService)
	return _c
}

func (_c *Client_GetTemplate_Call) RunAndReturn(run func(name string) elasticsearch.IndicesGetIndexTemplateService) *Client_GetTemplate_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewIndicesGetIndexTemplateService creates a new instance of IndicesGetIndexTemplateService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIndicesGetIndexTemplateService(t interface {
	mock.TestingT
	Cleanup(func())
}) *IndicesGetIndexTemplateService {
	mock := &IndicesGetIndexTemplateService{}
	mock.Mock.Test(t)
...
// IndicesGetIndexTemplateService is an autogenerated mock type for the IndicesGetIndexTemplateService type
type IndicesGetIndexTemplateService struct {
	mock.Mock
}

type IndicesGetIndexTemplateService_Expecter struct {
	mock *mock.Mock
}

func (_m *IndicesGetIndexTemplateService) EXPECT() *IndicesGetIndexTemplateService_Expecter {
	return &IndicesGetIndexTemplateService_Expecter{mock: &_m.Mock}
}

// Do provides a mock function for the type IndicesGetIndexTemplateService
func (_mock *IndicesGetIndexTemplateService) Do(ctx context.Context) (*elastic.IndicesGetIndexTemplateResponse, error) {
	ret := _mock.Called(ctx)
	...
	var r0 *elastic.IndicesGetIndexTemplateResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (*elastic.IndicesGetIndexTemplateResponse, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) *elastic.IndicesGetIndexTemplateResponse); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*elastic.IndicesGetIndexTemplateResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context) error); ok {
		r1 = returnFunc(ctx)
...
// IndicesGetIndexTemplateService_Do_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Do'
type IndicesGetIndexTemplateService_Do_Call struct {
	*mock.Call
}

// Do is a helper method to define mock.On call
//   - ctx context.Context
func (_e *IndicesGetIndexTemplateService_Expecter) Do(ctx interface{}) *IndicesGetIndexTemplateService_Do_Call {
	return &IndicesGetIndexTemplateService_Do_Call{Call: _e.mock.On("Do", ctx)}
}

func (_c *IndicesGetIndexTemplateService_Do_Call) Run(run func(ctx context.Context)) *IndicesGetIndexTemplateService_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *IndicesGetIndexTemplateService_Do_Call) Return(indicesGetIndexTemplateResponse *elastic.IndicesGetIndexTemplateResponse, err error) *IndicesGetIndexTemplateService_Do_Call {
	_c.Call.Return(indicesGetIndexTemplateResponse, err)
	return _c
}

func (_c *IndicesGetIndexTemplateService_Do_Call) RunAndReturn(run func(ctx context.Context) (*elastic.IndicesGetIndexTemplateResponse, error)) *IndicesGetIndexTemplateService_Do_Call {
	_c.Call.Return(run)
	return _c
}
