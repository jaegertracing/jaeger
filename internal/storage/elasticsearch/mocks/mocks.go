...
// Transform provides a mock function for the type Client
func (_mock *Client) Transform() elasticsearch.TransformService {
	ret := _mock.Called()
	...
	var r0 elasticsearch.TransformService
	if returnFunc, ok := ret.Get(0).(func() elasticsearch.TransformService); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elasticsearch.TransformService)
		}
	}
	return r0
}

// Client_Transform_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Transform'
type Client_Transform_Call struct {
	*mock.Call
}

// Transform is a helper method to define mock.On call
func (_e *Client_Expecter) Transform() *Client_Transform_Call {
	return &Client_Transform_Call{Call: _e.mock.On("Transform")}
}

func (_c *Client_Transform_Call) Run(run func()) *Client_Transform_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Client_Transform_Call) Return(transformService elasticsearch.TransformService) *Client_Transform_Call {
	_c.Call.Return(transformService)
	return _c
}

func (_c *Client_Transform_Call) RunAndReturn(run func() elasticsearch.TransformService) *Client_Transform_Call {
	_c.Call.Return(run)
	return _c
}
...
// Delete provides a mock function for the type TransformService
func (_mock *TransformService) Delete(ctx context.Context, id string) error {
...
// TransformService_Delete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Delete'
type TransformService_Delete_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *TransformService_Expecter) Delete(ctx interface{}, id interface{}) *TransformService_Delete_Call {
	return &TransformService_Delete_Call{Call: _e.mock.On("Delete", ctx, id)}
}

func (_c *TransformService_Delete_Call) Run(run func(ctx context.Context, id string)) *TransformService_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *TransformService_Delete_Call) Return(err error) *TransformService_Delete_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *TransformService_Delete_Call) RunAndReturn(run func(ctx context.Context, id string) error) *TransformService_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function for the type TransformService
func (_mock *TransformService) Get(ctx context.Context, id string) ([]byte, error) {
	ret := _mock.Called(ctx, id)
...
// TransformService_Get_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Get'
type TransformService_Get_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *TransformService_Expecter) Get(ctx interface{}, id interface{}) *TransformService_Get_Call {
	return &TransformService_Get_Call{Call: _e.mock.On("Get", ctx, id)}
}

func (_c *TransformService_Get_Call) Run(run func(ctx context.Context, id string)) *TransformService_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *TransformService_Get_Call) Return(bytes []byte, err error) *TransformService_Get_Call {
	_c.Call.Return(bytes, err)
	return _c
}

func (_c *TransformService_Get_Call) RunAndReturn(run func(ctx context.Context, id string) ([]byte, error)) *TransformService_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Put provides a mock function for the type TransformService
func (_mock *TransformService) Put(ctx context.Context, id string, body string) error {
...
// TransformService_Put_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Put'
type TransformService_Put_Call struct {
	*mock.Call
}
...
//   - id string
//   - body string
func (_e *TransformService_Expecter) Put(ctx interface{}, id interface{}, body interface{}) *TransformService_Put_Call {
	return &TransformService_Put_Call{Call: _e.mock.On("Put", ctx, id, body)}
}

func (_c *TransformService_Put_Call) Run(run func(ctx context.Context, id string, body string)) *TransformService_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *TransformService_Put_Call) Return(err error) *TransformService_Put_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *TransformService_Put_Call) RunAndReturn(run func(ctx context.Context, id string, body string) error) *TransformService_Put_Call {
	_c.Call.Return(run)
	return _c
}

// Start provides a mock function for the type TransformService
func (_mock *TransformService) Start(ctx context.Context, id string) error {
	ret := _mock.Called(ctx, id)
...
// TransformService_Start_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Start'
type TransformService_Start_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *TransformService_Expecter) Start(ctx interface{}, id interface{}) *TransformService_Start_Call {
	return &TransformService_Start_Call{Call: _e.mock.On("Start", ctx, id)}
}

func (_c *TransformService_Start_Call) Run(run func(ctx context.Context, id string)) *TransformService_Start_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *TransformService_Start_Call) Return(err error) *TransformService_Start_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *TransformService_Start_Call) RunAndReturn(run func(ctx context.Context, id string) error) *TransformService_Start_Call {
	_c.Call.Return(run)
	return _c
}
