...
type GetDependenciesRequest struct {
	// Required end time of the interval.
	EndTime time.Time `protobuf:"bytes,1,opt,name=end_time,json=endTime,proto3,stdtime" json:"end_time"`
	// Required lookback duration.
	Lookback             time.Duration `protobuf:"bytes,2,opt,name=lookback,proto3,stdduration" json:"lookback"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
// DependencyLink encapsulates information about dependency between services.
type DependencyLink struct {
	// Name of the service that is the parent of the dependency.
	Parent string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	// Name of the service that is the child of the dependency.
	Child string `protobuf:"bytes,2,opt,name=child,proto3" json:"child,omitempty"`
	// Number of calls from parent to child.
...
func (m *GetDependenciesResponse) GetDependencies() []*DependencyLink {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DependencyLink)(nil), "jaeger.api_v3.DependencyLink")
...
var fileDescriptor_5fcb6756dc1afb8d = []byte{
	...
	,
}
...
func (m *GetDependenciesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n8, err8 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Lookback, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.Lookback):])
	if err8 != nil {
		return 0, err8
	}
	i -= n8
...
func (m *DependencyLink) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Source) > 0 {
		...
		i = encodeVarintQueryService(dAtA, i, uint64(len(m.Source)))
		i--
		dAtA[i] = 0x22
	}
	if m.CallCount != 0 {
...
func (m *GetDependenciesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Dependencies = append(m.Dependencies, &DependencyLink{})
