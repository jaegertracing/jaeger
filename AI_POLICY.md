...
- Letting an agent answer review feedback on your behalf, so that no human has actually engaged with the reviewer's point. Whether a tool helped you write the words matters much less than whether the position is yours.
