...
.PHONY: kafka-kerberos-integration-test
kafka-kerberos-integration-test:
	go clean -testcache
	bash -c "set -e; set -o pipefail; $(GOTEST) -tags kafka_kerberos -run TestKafkaKerberosStorage $(STORAGE_PKGS) | $(COLORIZE)"
