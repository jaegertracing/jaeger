...
build-examples:
	...
	go build -o ./examples/hotrod/hotrod-$(GOOS) ./examples/hotrod/main.go
...
.PHONY: build-agent
build-agent:
	go build -o ./cmd/agent/agent-$(GOOS) $(BUILD_INFO) ./cmd/agent/main.go

.PHONY: build-query
build-query:
	go build -tags ui -o ./cmd/query/query-$(GOOS) $(BUILD_INFO) ./cmd/query/main.go

.PHONY: build-collector
build-collector: elasticsearch-mappings
	go build -o ./cmd/collector/collector-$(GOOS) $(BUILD_INFO) ./cmd/collector/main.go

.PHONY: build-ingester
build-ingester:
	go build -o ./cmd/ingester/ingester-$(GOOS) $(BUILD_INFO) ./cmd/ingester/main.go
...
build-crossdock-linux:
	GOOS=linux go build -o ./crossdock/crossdock-linux ./crossdock/main.go
