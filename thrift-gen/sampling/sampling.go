...
func (p *ProbabilisticSamplingStrategy) Validate() error {
  return nil
}
// Attributes:
//  - MaxTracesPerSecond
...
func (p *RateLimitingSamplingStrategy) Validate() error {
  return nil
}
// Attributes:
//  - Operation
...
func (p *OperationSamplingStrategy) Validate() error {
  return nil
}
// Attributes:
...
func (p *PerOperationSamplingStrategies) Validate() error {
  return nil
}
// Attributes:
//  - StrategyType
...
func (p *SamplingStrategyResponse) Validate() error {
  return nil
}
...
func (p *SamplingManagerClient) GetSamplingStrategy(ctx context.Context, serviceName string) (_r *SamplingStrategyResponse, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "getSamplingStrategy failed: unknown result")
}
...
func NewSamplingManagerProcessor(handler SamplingManager) *SamplingManagerProcessor {
  ...
  self6 := &SamplingManagerProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self6.processorMap["getSamplingStrategy"] = &samplingManagerProcessorGetSamplingStrategy{handler:handler}
return self6
}
...
func (p *samplingManagerProcessorGetSamplingStrategy) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetSamplingStrategy(ctx, args.ServiceName); err2 != nil {
    ...
    _exc9 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getSamplingStrategy: " + err2.Error())
    if err2 := oprot.WriteMessageBegin(ctx, "getSamplingStrategy", thrift.EXCEPTION, seqId); err2 != nil {
