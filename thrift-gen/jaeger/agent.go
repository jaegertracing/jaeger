...
func NewEmitBatchArgs() *EmitBatchArgs {
	return &EmitBatchArgs{}
}

var EmitBatchArgs_Batch_DEFAULT *Batch

func (p *EmitBatchArgs) GetBatch() *Batch {
	if !p.IsSetBatch() {
		return EmitBatchArgs_Batch_DEFAULT
	}
	return p.Batch
}
func (p *EmitBatchArgs) IsSetBatch() bool {
	return p.Batch != nil
}

func (p *EmitBatchArgs) Read(iprot thrift.TProtocol) error {
...
func (p *EmitBatchArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Batch = &Batch{}
...
func (p *EmitBatchArgs) Write(oprot thrift.TProtocol) error {
...
func (p *EmitBatchArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *EmitBatchArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EmitBatchArgs(%+v)", *p)
}
