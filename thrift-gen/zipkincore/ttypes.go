...
type Span struct {
	...
	Timestamp         *int64              `thrift:"timestamp,10" json:"timestamp"`
	Duration          *int64              `thrift:"duration,11" json:"duration"`
}
...
func (p *Span) writeField10(oprot thrift.TProtocol) (err error) {
	if p.IsSetTimestamp() {
		if err := oprot.WriteFieldBegin("timestamp", thrift.I64, 10); err != nil {
			return fmt.Errorf("%T write field begin error 10:timestamp: %s", p, err)
		}
		if err := oprot.WriteI64(int64(*p.Timestamp)); err != nil {
			return fmt.Errorf("%T.timestamp (10) field write error: %s", p, err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return fmt.Errorf("%T write field end error 10:timestamp: %s", p, err)
		}
	}
	return err
}
...
func (p *Span) writeField11(oprot thrift.TProtocol) (err error) {
	if p.IsSetDuration() {
		if err := oprot.WriteFieldBegin("duration", thrift.I64, 11); err != nil {
			return fmt.Errorf("%T write field begin error 11:duration: %s", p, err)
		}
		if err := oprot.WriteI64(int64(*p.Duration)); err != nil {
			return fmt.Errorf("%T.duration (11) field write error: %s", p, err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return fmt.Errorf("%T write field end error 11:duration: %s", p, err)
		}
	}
	return err
}
