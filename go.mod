...
require (
	...
	go.opentelemetry.io/collector/config/configgrpc v0.94.0
...
require (
	...
	go.opentelemetry.io/collector/config/configcompression v0.94.0 // indirect
	go.opentelemetry.io/collector/config/confignet v0.94.0 // indirect
