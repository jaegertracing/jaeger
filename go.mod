...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage v0.148.0
	...
	go.opentelemetry.io/collector/config/configauth v1.55.0
	go.opentelemetry.io/collector/config/configgrpc v0.149.0
	go.opentelemetry.io/collector/config/confighttp v0.149.0
	go.opentelemetry.io/collector/config/confighttp/xconfighttp v0.149.0
...
require (
	...
	go.opentelemetry.io/collector/config/configmiddleware v1.55.0
	...
	go.opentelemetry.io/collector/extension/extensioncapabilities v0.149.0
	...
	go.opentelemetry.io/collector/pdata/xpdata v0.149.0
