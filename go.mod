...
require (
	...
	go.opentelemetry.io/collector/config/configgrpc v0.122.0
	go.opentelemetry.io/collector/config/confighttp v0.122.0
	go.opentelemetry.io/collector/config/confighttp/xconfighttp v0.122.0
...
require (
	...
	go.opentelemetry.io/collector/extension/extensioncapabilities v0.122.0
