...
require (
	...
	github.com/jaegertracing/jaeger-idl v0.13.0
	...
	go.opentelemetry.io/collector/config/confighttp/xconfighttp v0.160.0
	go.opentelemetry.io/collector/config/configmiddleware v1.66.0
