...
- For the Prometheus option, visualize raw metrics in the Prometheus UI at http://localhost:9090/query (e.g., http://localhost:9090/query?g0.expr=traces\_span\_metrics\_calls\_total\&g0.tab=0\&g0.range\_input=5m).
