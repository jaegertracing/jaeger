...
func TestSuccessfulUnderlyingCalls(t *testing.T) {
	...
	mockReader.On("GetTrace", context.Background(), spanstore.TraceGetParameters{TraceID: model.TraceID{}}).Return(&model.Trace{}, nil)
	mrs.GetTrace(context.Background(), spanstore.TraceGetParameters{TraceID: model.TraceID{}})
...
func TestFailingUnderlyingCalls(t *testing.T) {
	...
	mockReader.On("GetOperations", context.Background(), operationQuery).
		Return(nil, errors.New("Failure"))
	mrs.GetOperations(context.Background(), operationQuery)
	mockReader.On("GetTrace", context.Background(), spanstore.TraceGetParameters{TraceID: model.TraceID{}}).
		Return(nil, errors.New("Failure"))
	mrs.GetTrace(context.Background(), spanstore.TraceGetParameters{TraceID: model.TraceID{}})
	mockReader.On("FindTraces", context.Background(), &spanstore.TraceQueryParameters{}).
		Return(nil, errors.New("Failure"))
