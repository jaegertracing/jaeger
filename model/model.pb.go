...
type SpanRef struct {
	TraceID TraceID     `protobuf:"bytes,1,opt,name=trace_id,json=traceId,customtype=TraceID" json:"trace_id"`
...
type TraceID struct {
	Low  uint64 `protobuf:"varint,1,opt,name=low,proto3" json:"lo"`
	High uint64 `protobuf:"varint,2,opt,name=high,proto3" json:"hi"`
}

func (m *TraceID) Reset()                    { *m = TraceID{} }
func (m *TraceID) String() string            { return proto.CompactTextString(m) }
func (*TraceID) ProtoMessage()               {}
func (*TraceID) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{5} }
...
func (*Trace) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{6} }
...
func (*Trace_ProcessMapping) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{6, 0} }
...
func (*Batch) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{7} }
...
func init() {
	...
	proto.RegisterType((*TraceID)(nil), "jaeger.api_v2.TraceID")
	golang_proto.RegisterType((*TraceID)(nil), "jaeger.api_v2.TraceID")
...
func (m *TraceID) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Low != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintModel(dAtA, i, uint64(m.Low))
	}
	if m.High != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintModel(dAtA, i, uint64(m.High))
	}
	return i, nil
}
...
func (m *TraceID) Size() (n int) {
	...
	_ = l
	if m.Low != 0 {
		n += 1 + sovModel(uint64(m.Low))
	}
	if m.High != 0 {
		n += 1 + sovModel(uint64(m.High))
	}
	return n
}
...
var fileDescriptorModel = []byte{
	...
	,
}
