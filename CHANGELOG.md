...
* Refactor(es): introduce rotation interface for index management ([@yurishkuro](https://github.com/yurishkuro) in [#8808](https://github.com/jaegertracing/jaeger/pull/8808))
