...
* Fix: tools api missmatch between acp and jaeger gateway ([@Nabil-Salah](https://github.com/Nabil-Salah) in [#8608](https://github.com/jaegertracing/jaeger/pull/8608))
