...
type TraceQueryParameters struct {
	...
	CheckTagsPresent     []string          `protobuf:"bytes,9,rep,name=check_tags_present,json=checkTagsPresent,proto3" json:"check_tags_present,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *TraceQueryParameters) GetCheckTagsPresent() []string {
	if m != nil {
		return m.CheckTagsPresent
	}
	return nil
}
...
var fileDescriptor_26651706f9f8a4f0 = []byte{
	...
	,
}
...
func (m *TraceQueryParameters) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CheckTagsPresent) > 0 {
		for _, s := range m.CheckTagsPresent {
			dAtA[i] = 0x4a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *TraceQueryParameters) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckTagsPresent", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CheckTagsPresent = append(m.CheckTagsPresent, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
