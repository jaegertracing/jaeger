...
build-esmapping-generator:
	$(GOBUILD) $(BUILD_INFO) -o ./internal/storage/v1/elasticsearch/esmapping-generator-$(GOOS)-$(GOARCH) ./cmd/esmapping-generator/

.PHONY: build-esmapping-generator-linux
build-esmapping-generator-linux:
	 GOOS=linux $(BUILD_INFO) GOARCH=amd64 $(GOBUILD) -o ./internal/storage/v1/elasticsearch/esmapping-generator ./cmd/esmapping-generator/
