...
* **Date**: 2026-03-01, extended 2026-07-29 (binary coverage, upload-invariant check, Codecov follow-up resolved), extended 2026-08-19 (the in-run summary check is the required context), extended 2026-09-05 (the unit-test leg collects counters instead of a text profile)
