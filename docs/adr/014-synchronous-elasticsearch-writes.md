...
* [`cmd/jaeger/internal/connectors/storagewriterconnector/`](../../cmd/jaeger/internal/connectors/storagewriterconnector/) — the connector form of `jaeger_storage_exporter`, which feeds a dead-letter pipeline
