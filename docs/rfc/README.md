...
- [0014: Change-Relevance-Aware CI](./0014-change-relevance-aware-ci.md) - Skip CI jobs a change cannot affect, deriving relevance from the Go build graph and measured per-job executed-package sets rather than hand-written path filters
