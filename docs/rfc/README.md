...
- [0013: Reliable Coverage Gating and Real E2E Coverage](./0013-coverage-gating-and-e2e-coverage.md) - Finish ADR-004's migration of coverage gating off Codecov, and collect coverage from the jaeger binary the e2e tests actually spawn
