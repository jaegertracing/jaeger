...
func (s *StorageIntegration) testArchiveTrace(t *testing.T) {
	...
	found := s.waitForCondition(t, func(_ *testing.T) bool {
		var err error
		actual, err = s.ArchiveSpanReader.GetTrace(context.Background(), spanstore.TraceGetParameters{TraceID: tID})
...
func (s *StorageIntegration) testGetLargeSpan(t *testing.T) {
	...
	found := s.waitForCondition(t, func(_ *testing.T) bool {
		var err error
		actual, err = s.SpanReader.GetTrace(context.Background(), spanstore.TraceGetParameters{TraceID: expectedTraceID})
...
func (s *StorageIntegration) testGetTrace(t *testing.T) {
	...
	t.Run("NotFound error", func(t *testing.T) {
		...
		trace, err := s.SpanReader.GetTrace(context.Background(), spanstore.TraceGetParameters{TraceID: fakeTraceID})
