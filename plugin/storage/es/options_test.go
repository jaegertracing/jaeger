...
func TestOptions(t *testing.T) {
	...
	assert.Equal(t, int64(5), primary.Indices.Spans.Shards)
	assert.Equal(t, int64(5), primary.Indices.Services.Shards)
	assert.Equal(t, int64(5), primary.Indices.Sampling.Shards)
	assert.Equal(t, int64(5), primary.Indices.Dependencies.Shards)
	assert.Equal(t, int64(1), primary.Indices.Spans.Replicas)
	assert.Equal(t, int64(1), primary.Indices.Services.Replicas)
	assert.Equal(t, int64(1), primary.Indices.Sampling.Replicas)
	assert.Equal(t, int64(1), primary.Indices.Dependencies.Replicas)
...
func TestOptionsWithFlags(t *testing.T) {
	...
	assert.Equal(t, int64(5), aux.Indices.Spans.Shards)
	assert.Equal(t, int64(5), aux.Indices.Services.Shards)
	assert.Equal(t, int64(5), aux.Indices.Sampling.Shards)
	assert.Equal(t, int64(5), aux.Indices.Dependencies.Shards)
	assert.Equal(t, int64(10), aux.Indices.Spans.Replicas)
	assert.Equal(t, int64(10), aux.Indices.Services.Replicas)
	assert.Equal(t, int64(10), aux.Indices.Sampling.Replicas)
	assert.Equal(t, int64(10), aux.Indices.Dependencies.Replicas)
