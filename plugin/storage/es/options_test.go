...
func TestOptions(t *testing.T) {
	...
	assert.Equal(t, 5, primary.Indices.Spans.TemplateOptions.NumShards)
	assert.Equal(t, 5, primary.Indices.Services.TemplateOptions.NumShards)
	assert.Equal(t, 5, primary.Indices.Sampling.TemplateOptions.NumShards)
	assert.Equal(t, 5, primary.Indices.Dependencies.TemplateOptions.NumShards)
	assert.Equal(t, 1, primary.Indices.Spans.TemplateOptions.NumReplicas)
	assert.Equal(t, 1, primary.Indices.Services.TemplateOptions.NumReplicas)
	assert.Equal(t, 1, primary.Indices.Sampling.TemplateOptions.NumReplicas)
	assert.Equal(t, 1, primary.Indices.Dependencies.TemplateOptions.NumReplicas)
...
func TestOptionsWithFlags(t *testing.T) {
	...
	assert.Equal(t, 5, aux.Indices.Spans.TemplateOptions.NumShards)
	assert.Equal(t, 5, aux.Indices.Services.TemplateOptions.NumShards)
	assert.Equal(t, 5, aux.Indices.Sampling.TemplateOptions.NumShards)
	assert.Equal(t, 5, aux.Indices.Dependencies.TemplateOptions.NumShards)
	assert.Equal(t, 10, aux.Indices.Spans.TemplateOptions.NumReplicas)
	assert.Equal(t, 10, aux.Indices.Services.TemplateOptions.NumReplicas)
	assert.Equal(t, 10, aux.Indices.Sampling.TemplateOptions.NumReplicas)
	assert.Equal(t, 10, aux.Indices.Dependencies.TemplateOptions.NumReplicas)
