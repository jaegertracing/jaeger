...
// plugin/storage/es/mappings/service-mapping.json
// plugin/storage/es/mappings/span-mapping.json
// DO NOT EDIT!
...
func spanMappingJson() (*asset, error) {
	bytes, err := spanMappingJsonBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "span-mapping.json", size: 3776, mode: os.FileMode(436), modTime: time.Unix(1548942679, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	".nocover": Nocover,
	"service-mapping.json": serviceMappingJson,
	"span-mapping.json": spanMappingJson,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"service-mapping.json": &bintree{serviceMappingJson, map[string]*bintree{}},
	"span-mapping.json": &bintree{spanMappingJson, map[string]*bintree{}},
}}
