...
type GetTraceRequest struct {
	TraceID jaeger_api_v2.TraceID `protobuf:"bytes,1,opt,name=trace_id,json=traceId" json:"trace_id"`
}
...
func (m *GetTraceRequest) GetTraceID() jaeger_api_v2.TraceID {
	if m != nil {
		return m.TraceID
	}
	return jaeger_api_v2.TraceID{}
}
