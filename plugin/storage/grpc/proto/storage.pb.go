...
func (m *FindTracesResponse) GetError() *GrpcStoragePluginError {
...
func (*GrpcStoragePluginError) Descriptor() ([]byte, []int) { return fileDescriptorStorage, []int{22} }
...
func (c *grpcSpanReaderStoragePluginClient) FindTraces(ctx context.Context, in *FindTracesRequest, opts ...grpc.CallOption) (*FindTracesResponse, error) {
	out := new(FindTracesResponse)
	err := grpc.Invoke(ctx, "/jaeger.api_v2.GrpcSpanReaderStoragePlugin/FindTraces", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GrpcSpanReaderStoragePlugin_FindTraces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindTracesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpcSpanReaderStoragePluginServer).FindTraces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jaeger.api_v2.GrpcSpanReaderStoragePlugin/FindTraces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcSpanReaderStoragePluginServer).FindTraces(ctx, req.(*FindTracesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorStorage = []byte{
	...
	,
}
