...
func (t *mockAggregator) RecordThroughput(string, string, model.SamplerType, float64) {
	t.callCount.Add(1)
}
...
func (*mockStrategyStore) GetSamplingStrategy(context.Context, string) (*api_v2.SamplingStrategyResponse, error) {
