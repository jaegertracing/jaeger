...
func (qs QueryService) GetTrace(ctx context.Context, query spanstore.TraceGetParameters) (*model.Trace, error) {
...
func (qs QueryService) ArchiveTrace(ctx context.Context, query spanstore.TraceGetParameters) error {
