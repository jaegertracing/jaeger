...
func TestGetTraceSuccess(t *testing.T) {
	...
	tqs.spanReader.On("GetTrace", mock.AnythingOfType("*context.valueCtx"), mock.AnythingOfType("spanstore.TraceGetParameters")).
		Return(mockTrace, nil).Once()

	type contextKey string
	ctx := context.Background()
	query := spanstore.TraceGetParameters{TraceID: mockTraceID}
...
func TestGetTraceFromArchiveStorage(t *testing.T) {
	...
	tqs.spanReader.On("GetTrace", mock.AnythingOfType("*context.valueCtx"), mock.AnythingOfType("spanstore.TraceGetParameters")).
		Return(nil, spanstore.ErrTraceNotFound).Once()
	tqs.archiveSpanReader.On("GetTrace", mock.AnythingOfType("*context.valueCtx"), mock.AnythingOfType("spanstore.TraceGetParameters")).
		Return(mockTrace, nil).Once()
