...
const (
	...
	agentHostPort            = "query.agent-host-port"
)
...
type QueryOptions struct {
	...
	// AgentHostPort is the agent's location, receiving spans generated by this service
...
func AddFlags(flagSet *flag.FlagSet) {
	...
	flagSet.String(agentHostPort, "", "The agent's location, receiving spans generated by this service")
}
...
func (qOpts *QueryOptions) InitFromViper(v *viper.Viper) *QueryOptions {
	...
	qOpts.AgentHostPort = v.GetString(agentHostPort)
	return qOpts
}
