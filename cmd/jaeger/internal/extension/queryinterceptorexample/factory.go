...
// implements queryinterceptor.Interceptor. It exists to show that the Option-D
// extension point is an ordinary OTel extension — added to the config's
// extensions list and referenced by jaeger_query.query_interceptors — not a
// Jaeger fork. The logic is deliberately trivial (static deny/redact lists), as
