...
type TraceSummary struct {
	...
	IsGenai           bool     `json:"is_genai" jsonschema:"Whether the trace was generated by an AI system"`
	ModelName         string   `json:"model_name" jsonschema:"The name of the GenAI model requested (e.g., gpt-4)"`
	AgentName         string   `json:"agent_name" jsonschema:"The name of the agent framework used (e.g., langchain)"`
	TotalInputTokens  int      `json:"total_input_tokens" jsonschema:"Total number of input tokens used by the GenAI model"`
	TotalOutputTokens int      `json:"total_output_tokens" jsonschema:"Total number of output tokens used by the GenAI model"`
}
