...
const (
	...
	routeGetDeepDependencies = "/api/v3/deep-dependencies"
)
...
func (h *HTTPGateway) RegisterRoutes(router *http.ServeMux) {
	...
	h.addRoute(router, h.deepDependencies, routeGetDeepDependencies, http.MethodGet)
}
...
func (h *HTTPGateway) deepDependencies(w http.ResponseWriter, _ *http.Request) {
	h.marshalResponse(&api_v3.DependenciesResponse{}, w)
}
