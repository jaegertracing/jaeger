...
- **`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver/Config`**: Refer to *[#/definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.Config](#definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.Config)*.
...
- <a id="definitions/github.com/jaegertracing/jaeger/cmd/jaeger/internal/extension/jaegerquery.Storage"></a>**`github.com/jaegertracing/jaeger/cmd/jaeger/internal/extension/jaegerquery.Storage`** *(object)*: .
  ...
  - **`TracesPrimary`** *(string, required)*: TracesPrimary contains the name of the primary trace storage that is being queried.
...
- <a id="definitions/github.com/jaegertracing/jaeger/cmd/jaeger/internal/extension/remotesampling.Config"></a>**`github.com/jaegertracing/jaeger/cmd/jaeger/internal/extension/remotesampling.Config`** *(object)*: .
  ...
  - **`GRPC`** *(string, required)*: . Default: `{"Auth": null, "IncludeMetadata": false, "Keepalive": null, "MaxConcurrentStreams": 0, "MaxRecvMsgSizeMiB": 0, "NetAddr": {"DialerConfig": {"Timeout": 0}, "Endpoint": ":5779", "Transport": "tcp"}, "ReadBufferSize": 0, "TLSSetting": null, "WriteBufferSize": 0}`.
...
- <a id="definitions/github.com/jaegertracing/jaeger/cmd/query/app.dependenciesQueryParameters"></a>**`github.com/jaegertracing/jaeger/cmd/query/app.dependenciesQueryParameters`** *(object)*: .
  - **`endTs`** *(string)*: .
  - **`lookback`** *(string)*: .
- <a id="definitions/github.com/jaegertracing/jaeger/cmd/query/app.handlerOptions"></a>**`github.com/jaegertracing/jaeger/cmd/query/app.handlerOptions`** *(object)*: .
...
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/exporter/kafkaexporter.kafkaErrors"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/exporter/kafkaexporter.kafkaErrors`** *(object)*: .
  - **`count`** *(integer)*: .
  - **`err`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/exporter/kafkaexporter.kafkaExporterFactory"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/exporter/kafkaexporter.kafkaExporterFactory`** *(object)*: .
...
If the value cannot be converted, the original value will be left as-is.
  - **`FromAttribute`** *(string, required)*: FromAttribute specifies the attribute to use to populate
...
A match occurs if the metric name matches at least one string pattern in this list.
  ...
  - **`ResourceAttributes`** *(array, required)*: ResourceAttributes defines a list of possible resource attributes to match metrics against.
...
previously committed. Must be `latest` or `earliest` (default "latest").
  - **`MaxFetchSize`** *(integer, required)*: The maximum bytes per fetch from Kafka (default "0", no limit).
...
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka/configkafka.SASLConfig"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka/configkafka.SASLConfig`** *(object)*: SASLConfig defines the configuration for the SASL authentication.
...
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor.RateAllocationCfg"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor.RateAllocationCfg`** *(object)*: RateAllocationCfg used within composite policy.
...
used for that policy.
  ...
  - **`name`** *(string)*: name used to identify this policy instance.
...
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.MessageMarking"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.MessageMarking`** *(object)*: .
  ...
  - **`OnError`** *(boolean, required)*: If false, only the successfully processed messages are marked, it has no impact if
...
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaLogsConsumer"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaLogsConsumer`** *(object)*: kafkaLogsConsumer uses sarama to consume and handle messages from kafka.
  ...
  - **`nextConsumer`** *(string)*: .
  - **`settings`** *(string)*: .
  - **`telemetryBuilder`** *(string)*: .
  - **`topics`** *(array)*: .
    - **Items** *(string)*
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaMetricsConsumer"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaMetricsConsumer`** *(object)*: kafkaMetricsConsumer uses sarama to consume and handle messages from kafka.
  - **`autocommitEnabled`** *(boolean)*: .
  - **`cancelConsumeLoop`** *(string)*: .
  - **`config`** *(string)*: .
  - **`consumeLoopWG`** *(string)*: .
  ...
  - **`topics`** *(array)*: .
    - **Items** *(string)*
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaReceiverFactory"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaReceiverFactory`** *(object)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaTracesConsumer"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.kafkaTracesConsumer`** *(object)*: kafkaTracesConsumer uses sarama to consume and handle messages from kafka.
  - **`autocommitEnabled`** *(boolean)*: .
  - **`cancelConsumeLoop`** *(string)*: .
  - **`config`** *(string)*: .
  - **`consumeLoopWG`** *(string)*: .
  ...
  - **`topics`** *(array)*: .
    - **Items** *(string)*
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.logsConsumerGroupHandler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.logsConsumerGroupHandler`** *(object)*: .
  - **`autocommitEnabled`** *(boolean)*: .
  - **`backOff`** *(string)*: .
  ...
  - **`telemetryBuilder`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.logsEncodingUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.logsEncodingUnmarshaler`** *(object)*: logsEncodingUnmarshaler is a wrapper around plog.Unmarshaler that implements LogsUnmarshaler.
  - **`encoding`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.metricsConsumerGroupHandler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.metricsConsumerGroupHandler`** *(object)*: .
  - **`autocommitEnabled`** *(boolean)*: .
  - **`backOff`** *(string)*: .
  - **`headerExtractor`** *(string)*: .
  - **`id`** *(string)*: .
  ...
  - **`telemetryBuilder`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.metricsEncodingUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.metricsEncodingUnmarshaler`** *(object)*: metricsEncodingUnmarshaler is a wrapper around pmetric.Unmarshaler that implements MetricsUnmarshaler.
  - **`encoding`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.nopHeaderExtractor"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.nopHeaderExtractor`** *(object)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataLogsUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataLogsUnmarshaler`** *(object)*: .
  - **`Unmarshaler`** *(string)*: .
  - **`encoding`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataMetricsUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataMetricsUnmarshaler`** *(object)*: .
  - **`Unmarshaler`** *(string)*: .
  - **`encoding`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataTracesUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.pdataTracesUnmarshaler`** *(object)*: .
  - **`Unmarshaler`** *(string)*: .
  - **`encoding`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.rawLogsUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.rawLogsUnmarshaler`** *(object)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.textLogsUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.textLogsUnmarshaler`** *(object)*: .
  - **`decoder`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.tracesConsumerGroupHandler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.tracesConsumerGroupHandler`** *(object)*: .
  - **`autocommitEnabled`** *(boolean)*: .
  - **`backOff`** *(string)*: .
  - **`headerExtractor`** *(string)*: .
  - **`id`** *(string)*: .
  ...
  - **`telemetryBuilder`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.tracesEncodingUnmarshaler"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkareceiver.tracesEncodingUnmarshaler`** *(object)*: tracesEncodingUnmarshaler is a wrapper around ptrace.Unmarshaler that implements TracesUnmarshaler.
  - **`encoding`** *(string)*: .
  - **`unmarshaler`** *(string)*: .
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.Config"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.Config`** *(object)*: Config defines configuration for Zipkin receiver.
  - **`ParseStringTags`** *(boolean, required)*: If enabled the zipkin receiver will attempt to parse string tags/binary annotations into int/bool/float.
Disabled by default. Default: `false`.
  - **`ServerConfig`** *(string, required)*: Configures the receiver server protocol.
- <a id="definitions/github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.zipkinReceiver"></a>**`github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver.zipkinReceiver`** *(object)*: zipkinReceiver type is used to handle spans received in the Zipkin format.
  - **`config`** *(string)*: .
  - **`jsonUnmarshaler`** *(string)*: .
  - **`nextConsumer`** *(string)*: .
  - **`obsrecvrs`** *(string)*: .
  - **`protobufDebugUnmarshaler`** *(string)*: .
  - **`protobufUnmarshaler`** *(string)*: .
  - **`server`** *(string)*: .
  - **`settings`** *(string)*: .
  - **`shutdownWG`** *(string)*: .
  - **`v1JSONUnmarshaler`** *(string)*: .
  - **`v1ThriftUnmarshaler`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.ClientConfig"></a>**`go.opentelemetry.io/collector/config/configgrpc.ClientConfig`** *(object)*: ClientConfig defines common settings for a gRPC client configuration.
  - **`Auth`** *(string)*: Auth configuration for outgoing RPCs.
  - **`Authority`** *(string)*: WithAuthority parameter configures client to rewrite ":authority" header
(godoc.org/google.golang.org/grpc#WithAuthority).
  - **`BalancerName`** *(string, required)*: Sets the balancer in grpclb_policy to discover the servers. Default is pick_first.
https://github.com/grpc/grpc-go/blob/master/examples/features/load_balancing/README.md.
  - **`Compression`** *(string)*: The compression key for supported compression types within collector.
  - **`Endpoint`** *(string)*: The target to which the exporter is going to send traces or metrics,
using the gRPC protocol. The valid syntax is described at
https://github.com/grpc/grpc/blob/master/doc/naming.md.
  - **`Headers`** *(string)*: The headers associated with gRPC requests.
  - **`Keepalive`** *(string)*: The keepalive parameters for gRPC client. See grpc.WithKeepaliveParams.
(https://godoc.org/google.golang.org/grpc#WithKeepaliveParams).
  - **`ReadBufferSize`** *(integer)*: ReadBufferSize for gRPC client. See grpc.WithReadBufferSize.
(https://godoc.org/google.golang.org/grpc#WithReadBufferSize).
  - **`TLSSetting`** *(string)*: TLSSetting struct exposes TLS client configuration.
  - **`WaitForReady`** *(boolean)*: WaitForReady parameter configures client to wait for ready state before sending data.
(https://github.com/grpc/grpc/blob/master/doc/wait-for-ready.md).
  - **`WriteBufferSize`** *(integer)*: WriteBufferSize for gRPC gRPC. See grpc.WithWriteBufferSize.
(https://godoc.org/google.golang.org/grpc#WithWriteBufferSize).
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.KeepaliveClientConfig"></a>**`go.opentelemetry.io/collector/config/configgrpc.KeepaliveClientConfig`** *(object)*: KeepaliveClientConfig exposes the keepalive.ClientParameters to be used by the exporter.
...
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.KeepaliveEnforcementPolicy"></a>**`go.opentelemetry.io/collector/config/configgrpc.KeepaliveEnforcementPolicy`** *(object)*: KeepaliveEnforcementPolicy allow configuration of the keepalive.EnforcementPolicy.
...
See https://godoc.org/google.golang.org/grpc/keepalive#EnforcementPolicy for details.
  - **`MinTime`** *(string)*: .
  - **`PermitWithoutStream`** *(boolean)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.KeepaliveServerConfig"></a>**`go.opentelemetry.io/collector/config/configgrpc.KeepaliveServerConfig`** *(object)*: KeepaliveServerConfig is the configuration for keepalive.
  - **`EnforcementPolicy`** *(string)*: .
  - **`ServerParameters`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.KeepaliveServerParameters"></a>**`go.opentelemetry.io/collector/config/configgrpc.KeepaliveServerParameters`** *(object)*: KeepaliveServerParameters allow configuration of the keepalive.ServerParameters.
...
See https://godoc.org/google.golang.org/grpc/keepalive#ServerParameters for details.
  ...
  - **`Time`** *(string)*: .
  - **`Timeout`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.ServerConfig"></a>**`go.opentelemetry.io/collector/config/configgrpc.ServerConfig`** *(object)*: ServerConfig defines common settings for a gRPC server configuration.
  - **`Auth`** *(string)*: Auth for this receiver.
  - **`IncludeMetadata`** *(boolean)*: Include propagates the incoming connection's metadata to downstream consumers.
  - **`Keepalive`** *(string)*: Keepalive anchor for all the settings related to keepalive.
  - **`MaxConcurrentStreams`** *(integer)*: MaxConcurrentStreams sets the limit on the number of concurrent streams to each ServerTransport.
It has effect only for streaming RPCs.
  - **`MaxRecvMsgSizeMiB`** *(integer)*: MaxRecvMsgSizeMiB sets the maximum size (in MiB) of messages accepted by the server.
  - **`NetAddr`** *(string, required)*: Server net.Addr config. For transport only "tcp" and "unix" are valid options.
  - **`ReadBufferSize`** *(integer)*: ReadBufferSize for gRPC server. See grpc.ReadBufferSize.
(https://godoc.org/google.golang.org/grpc#ReadBufferSize).
  - **`TLSSetting`** *(string)*: Configures the protocol to use TLS.
The default value is nil, which will cause the protocol to not use TLS.
  - **`WriteBufferSize`** *(integer)*: WriteBufferSize for gRPC server. See grpc.WriteBufferSize.
(https://godoc.org/google.golang.org/grpc#WriteBufferSize).
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.grpcDialOptionWrapper"></a>**`go.opentelemetry.io/collector/config/configgrpc.grpcDialOptionWrapper`** *(object)*: .
  - **`opt`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.grpcServerOptionWrapper"></a>**`go.opentelemetry.io/collector/config/configgrpc.grpcServerOptionWrapper`** *(object)*: .
  - **`opt`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configgrpc.wrappedServerStream"></a>**`go.opentelemetry.io/collector/config/configgrpc.wrappedServerStream`** *(object)*: wrappedServerStream is a thin wrapper around grpc.ServerStream that allows modifying context.
  - **`ServerStream`** *(string)*: .
  - **`wrappedCtx`** *(string)*: wrappedContext is the wrapper's own Context. You can assign it.
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.AuthConfig"></a>**`go.opentelemetry.io/collector/config/confighttp.AuthConfig`** *(object)*: .
  - **`Authentication`** *(string, required)*: Auth for this receiver.
  - **`RequestParameters`** *(array)*: RequestParameters is a list of parameters that should be extracted from the request and added to the context.
When a parameter is found in both the query string and the header, the value from the query string will be used.
    - **Items** *(string)*
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.CORSConfig"></a>**`go.opentelemetry.io/collector/config/confighttp.CORSConfig`** *(object)*: CORSConfig configures a receiver for HTTP cross-origin resource sharing (CORS).
See the underlying https://github.com/rs/cors package for details.
  - **`AllowedHeaders`** *(array)*: AllowedHeaders sets what headers will be allowed in CORS requests.
...
allow any request header.
    - **Items** *(string)*
  - **`AllowedOrigins`** *(array)*: AllowedOrigins sets the allowed values of the Origin header for
...
"http://*.domain.com", or "*" to allow any origin).
    - **Items** *(string)*
  - **`MaxAge`** *(integer)*: MaxAge sets the value of the Access-Control-Max-Age response header.
Set it to the number of seconds that browsers should cache a CORS
preflight response for.
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.ClientConfig"></a>**`go.opentelemetry.io/collector/config/confighttp.ClientConfig`** *(object)*: ClientConfig defines settings for creating an HTTP client.
  - **`Auth`** *(string)*: Auth configuration for outgoing HTTP calls.
  - **`Compression`** *(string)*: The compression key for supported compression types within collector.
  - **`CompressionParams`** *(string)*: Advanced configuration options for the Compression.
  - **`Cookies`** *(string)*: Cookies configures the cookie management of the HTTP client.
  - **`DisableKeepAlives`** *(boolean)*: DisableKeepAlives, if true, disables HTTP keep-alives and will only use the connection to the server
for a single HTTP request.<br>    WARNING: enabling this option can result in significant overhead establishing a new HTTP(S)
...
to idle connection settings can achieve your goal.
  - **`Endpoint`** *(string)*: The target URL to send data to (e.g.: http://some.url:9411/v1/traces).
  - **`HTTP2PingTimeout`** *(string)*: HTTP2PingTimeout if there's no response to the ping within the configured value, the connection will be closed.
If not set or set to 0, it defaults to 15s.
  - **`HTTP2ReadIdleTimeout`** *(string)*: This is needed in case you run into
...
0s means no health check will be performed.
  - **`Headers`** *(string)*: Additional headers attached to each HTTP request sent by the client.
Existing header values are overwritten if collision happens.
Header values are opaque since they may be sensitive.
  - **`IdleConnTimeout`** *(string, required)*: IdleConnTimeout is the maximum amount of time a connection will remain open before closing itself.
By default, it is set to 90 seconds.
  - **`MaxConnsPerHost`** *(integer)*: MaxConnsPerHost limits the total number of connections per host, including connections in the dialing,
active, and idle states. Default is 0 (unlimited).
  - **`MaxIdleConns`** *(integer, required)*: MaxIdleConns is used to set a limit to the maximum idle HTTP connections the client can keep open.
By default, it is set to 100. Zero means no limit.
  - **`MaxIdleConnsPerHost`** *(integer)*: MaxIdleConnsPerHost is used to set a limit to the maximum idle HTTP connections the host can keep open.
Default is 0 (unlimited).
  - **`ProxyURL`** *(string)*: ProxyURL setting for the collector.
  - **`ReadBufferSize`** *(integer)*: ReadBufferSize for HTTP client. See http.Transport.ReadBufferSize.
Default is 0.
  - **`TLSSetting`** *(string)*: TLSSetting struct exposes TLS client configuration.
  - **`Timeout`** *(string)*: Timeout parameter configures `http.Client.Timeout`.
Default is 0 (unlimited).
  - **`WriteBufferSize`** *(integer)*: WriteBufferSize for HTTP client. See http.Transport.WriteBufferSize.
Default is 0.
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.CookiesConfig"></a>**`go.opentelemetry.io/collector/config/confighttp.CookiesConfig`** *(object)*: CookiesConfig defines the configuration of the HTTP client regarding cookies served by the server.
  - **`Enabled`** *(boolean)*: Enabled if true, cookies from HTTP responses will be reused in further HTTP requests with the same server.
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.ServerConfig"></a>**`go.opentelemetry.io/collector/config/confighttp.ServerConfig`** *(object)*: ServerConfig defines settings for creating an HTTP server.
  - **`Auth`** *(string)*: Auth for this receiver.
  - **`CORS`** *(string, required)*: CORS configures the server for HTTP cross-origin resource sharing (CORS).
  - **`CompressionAlgorithms`** *(array)*: CompressionAlgorithms configures the list of compression algorithms the server can accept. Default: ["", "gzip", "zstd", "zlib", "snappy", "deflate"].
    - **Items** *(string)*
  - **`Endpoint`** *(string)*: Endpoint configures the listening address for the server.
  - **`IdleTimeout`** *(string, required)*: IdleTimeout is the maximum amount of time to wait for the
next request when keep-alives are enabled. If IdleTimeout
is zero, the value of ReadTimeout is used. If both are
zero, there is no timeout.
  - **`IncludeMetadata`** *(boolean)*: IncludeMetadata propagates the client metadata from the incoming requests to the downstream consumers.
  - **`MaxRequestBodySize`** *(integer)*: MaxRequestBodySize sets the maximum request body size in bytes. Default: 20MiB.
  - **`ReadHeaderTimeout`** *(string, required)*: ReadHeaderTimeout is the amount of time allowed to read
request headers. The connection's read deadline is reset
after reading the headers and the Handler can decide what
is considered too slow for the body. If ReadHeaderTimeout
is zero, the value of ReadTimeout is used. If both are
zero, there is no timeout.
  - **`ReadTimeout`** *(string)*: ReadTimeout is the maximum duration for reading the entire
request, including the body. A zero or negative value means
there will be no timeout.<br>    Because ReadTimeout does not let Handlers make per-request
decisions on each request body's acceptable deadline or
upload rate, most users will prefer to use
ReadHeaderTimeout. It is valid to use them both.
  - **`ResponseHeaders`** *(string, required)*: Additional headers attached to each HTTP response sent to the client.
Header values are opaque since they may be sensitive.
  - **`TLSSetting`** *(string, required)*: TLSSetting struct exposes TLS client configuration.
  - **`WriteTimeout`** *(string, required)*: WriteTimeout is the maximum duration before timing out
writes of the response. It is reset whenever a new
request's header is read. Like ReadTimeout, it does not
let Handlers make decisions on a per-request basis.
A zero or negative value means there will be no timeout.
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.clientInfoHandler"></a>**`go.opentelemetry.io/collector/config/confighttp.clientInfoHandler`** *(object)*: clientInfoHandler is an http.Handler that enhances the incoming request context with client.Info.
  - **`includeMetadata`** *(boolean)*: include client metadata or not.
  - **`next`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.compressReadCloser"></a>**`go.opentelemetry.io/collector/config/confighttp.compressReadCloser`** *(object)*: compressReadCloser couples the original compressed reader
and the compression reader to ensure that the original body
is correctly closed to ensure resources are freed.
  - **`Reader`** *(string)*: .
  - **`orig`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.compressRoundTripper"></a>**`go.opentelemetry.io/collector/config/confighttp.compressRoundTripper`** *(object)*: .
  - **`compressionParams`** *(string)*: .
  - **`compressionType`** *(string)*: .
  - **`compressor`** *(string)*: .
  - **`rt`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.compressionMapKey"></a>**`go.opentelemetry.io/collector/config/confighttp.compressionMapKey`** *(object)*: .
  - **`compressionParams`** *(string)*: .
  - **`compressionType`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.compressor"></a>**`go.opentelemetry.io/collector/config/confighttp.compressor`** *(object)*: .
  - **`pool`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.decompressor"></a>**`go.opentelemetry.io/collector/config/confighttp.decompressor`** *(object)*: .
  - **`base`** *(string)*: .
  - **`decoders`** *(string)*: .
  - **`errHandler`** *(string)*: .
  - **`maxRequestBodySize`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/confighttp.headerRoundTripper"></a>**`go.opentelemetry.io/collector/config/confighttp.headerRoundTripper`** *(object)*: Custom RoundTripper that adds headers.
  - **`headers`** *(string)*: .
  - **`transport`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/config/configretry.BackOffConfig"></a>**`go.opentelemetry.io/collector/config/configretry.BackOffConfig`** *(object)*: BackOffConfig defines configuration for retrying batches in case of export failure.
The current supported strategy is exponential backoff.
  - **`Enabled`** *(boolean, required)*: Enabled indicates whether to not retry sending batches in case of export failure.
  - **`InitialInterval`** *(string, required)*: InitialInterval the time to wait after the first failure before retrying.
  - **`MaxElapsedTime`** *(string, required)*: MaxElapsedTime is the maximum amount of time (including retries) spent trying to send a request/batch.
Once this value is reached, the data is discarded. If set to 0, the retries are never stopped.
  - **`MaxInterval`** *(string, required)*: MaxInterval is the upper bound on backoff interval. Once this value is reached the delay between
consecutive retries will always be `MaxInterval`.
  - **`Multiplier`** *(number, required)*: Multiplier is the value multiplied by the backoff interval bounds.
  - **`RandomizationFactor`** *(number, required)*: RandomizationFactor is a random factor used to calculate next backoffs
Randomized interval = RetryInterval * (1 ± RandomizationFactor).
- <a id="definitions/go.opentelemetry.io/collector/exporter/debugexporter.Config"></a>**`go.opentelemetry.io/collector/exporter/debugexporter.Config`** *(object)*: Config defines configuration for debug exporter.
  - **`SamplingInitial`** *(integer, required)*: SamplingInitial defines how many samples are initially logged during each second. Default: `2`.
  - **`SamplingThereafter`** *(integer, required)*: SamplingThereafter defines the sampling rate after the initial samples are logged. Default: `1`.
  - **`UseInternalLogger`** *(boolean, required)*: UseInternalLogger defines whether the exporter sends the output to the collector's internal logger. Default: `true`.
  - **`Verbosity`** *(string)*: Verbosity defines the debug exporter verbosity. Default: `"Basic"`.
- <a id="definitions/go.opentelemetry.io/collector/exporter/debugexporter.debugExporter"></a>**`go.opentelemetry.io/collector/exporter/debugexporter.debugExporter`** *(object)*: .
  - **`logger`** *(string)*: .
  - **`logsMarshaler`** *(string)*: .
  - **`metricsMarshaler`** *(string)*: .
  - **`profilesMarshaler`** *(string)*: .
  - **`tracesMarshaler`** *(string)*: .
  - **`verbosity`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterbatcher.Config"></a>**`go.opentelemetry.io/collector/exporter/exporterbatcher.Config`** *(object)*: Config defines a configuration for batching requests based on a timeout and a minimum number of items.
Experimental: This API is at the early stage of development and may change without backward compatibility
until https://github.com/open-telemetry/opentelemetry-collector/issues/8122 is resolved.
  - **`Enabled`** *(boolean, required)*: Enabled indicates whether to not enqueue batches before sending to the consumerSender.
  - **`FlushTimeout`** *(string, required)*: FlushTimeout sets the time after which a batch will be sent regardless of its size.
  - **`MaxSizeConfig`** *(string)*: [DEPRECATED] Deprecated: [v0.121.0] Ignored if SizeConfig is set.
  - **`MinSizeConfig`** *(string)*: [DEPRECATED] Deprecated: [v0.121.0] Ignored if SizeConfig is set.
  - **`SizeConfig`** *(string, required)*: SizeConfig sets the size limits for a batch.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterbatcher.MaxSizeConfig"></a>**`go.opentelemetry.io/collector/exporter/exporterbatcher.MaxSizeConfig`** *(object)*: Deprecated: [v0.121.0] use SizeConfig.
  - **`MaxSizeItems`** *(integer)*: [DEPRECATED] Deprecated: [v0.121.0] use SizeConfig.MaxSize.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterbatcher.MinSizeConfig"></a>**`go.opentelemetry.io/collector/exporter/exporterbatcher.MinSizeConfig`** *(object)*: Deprecated: [v0.121.0] use SizeConfig.
  - **`MinSizeItems`** *(integer)*: [DEPRECATED] Deprecated: [v0.121.0] use SizeConfig.MinSize.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterbatcher.SizeConfig"></a>**`go.opentelemetry.io/collector/exporter/exporterbatcher.SizeConfig`** *(object)*: SizeConfig sets the size limits for a batch.
  - **`MaxSize`** *(integer, required)*: MaxSize defines the configuration for the maximum size of a batch.
  - **`MinSize`** *(integer, required)*: MinSize defines the configuration for the minimum size of a batch.
  - **`Sizer`** *(string, required)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterbatcher.SizerType"></a>**`go.opentelemetry.io/collector/exporter/exporterbatcher.SizerType`** *(object)*: .
  - **`val`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.BaseExporter"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.BaseExporter`** *(object)*: .
  - **`ConsumerOptions`** *(array)*: .
    - **Items** *(string)*
  - **`ExportFailureMessage`** *(string)*: Message for the user to be added with an export failure message.
  - **`QueueSender`** *(string)*: Chain of senders that the exporter helper applies before passing the data to the actual exporter.
...
Most of the senders are optional, and initialized with a no-op path-through sender.
  ...
  - **`retryCfg`** *(string)*: .
  - **`timeoutCfg`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.MockHost"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.MockHost`** *(object)*: .
  - **`Ext`** *(string)*: .
  - **`Host`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.QueueSender"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.QueueSender`** *(object)*: .
  - **`batcher`** *(string)*: .
  - **`queue`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.TimeoutConfig"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.TimeoutConfig`** *(object)*: TimeoutConfig for timeout. The timeout applies to individual attempts to send data to the backend.
  - **`Timeout`** *(string, required)*: Timeout is the timeout for every attempt to send data to the backend.
A zero timeout means no timeout.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.obsQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.obsQueue`** *(object)*: obsQueue is a helper to add observability to a queue.
  - **`enqueueFailedInst`** *(string)*: .
  - **`metricAttr`** *(string)*: .
  - **`tb`** *(string)*: .
  - **`unknown`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.obsReportSender"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.obsReportSender`** *(object)*: .
  - **`ShutdownFunc`** *(string)*: .
  - **`StartFunc`** *(string)*: .
  - **`itemsFailedInst`** *(string)*: .
  - **`itemsSentInst`** *(string)*: .
  - **`metricAttr`** *(string)*: .
  - **`next`** *(string)*: .
  - **`spanAttrs`** *(string)*: .
  - **`spanName`** *(string)*: .
  - **`tracer`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.retrySender"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.retrySender`** *(object)*: .
  - **`StartFunc`** *(string)*: .
  - **`cfg`** *(string)*: .
  - **`logger`** *(string)*: .
  - **`next`** *(string)*: .
  - **`stopCh`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.sender"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.sender`** *(object)*: sender is a Sender that emits the incoming request to the exporter consumer func.
  - **`ShutdownFunc`** *(string)*: .
  - **`StartFunc`** *(string)*: .
  - **`consFunc`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.throttleRetry"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.throttleRetry`** *(object)*: TODO: Clean this by forcing all exporters to return an internal error type that always include the information about retries.
  - **`delay`** *(string)*: .
  - **`err`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterhelper/internal.timeoutSender"></a>**`go.opentelemetry.io/collector/exporter/exporterhelper/internal.timeoutSender`** *(object)*: timeoutSender is a requestSender that adds a `timeout` to every request that passes this sender.
  - **`ShutdownFunc`** *(string)*: .
  - **`StartFunc`** *(string)*: .
  - **`cfg`** *(string)*: .
  - **`next`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.Config"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.Config`** *(object)*: Config defines configuration for queueing requests before exporting.
It's supposed to be used with the new exporter helpers New[Traces|Metrics|Logs]RequestExporter.
Experimental: This API is at the early stage of development and may change without backward compatibility
until https://github.com/open-telemetry/opentelemetry-collector/issues/8122 is resolved.
  - **`Blocking`** *(boolean, required)*: Blocking controls the queue behavior when full.
If true it blocks until enough space to add the new request to the queue.
  - **`Enabled`** *(boolean, required)*: Enabled indicates whether to not enqueue batches before exporting.
  - **`NumConsumers`** *(integer, required)*: NumConsumers is the number of consumers from the queue.
  - **`QueueSize`** *(integer, required)*: QueueSize is the maximum number of requests allowed in queue at any given time.
  - **`StorageID`** *(string, required)*: StorageID if not empty, enables the persistent storage and uses the component specified
as a storage extension for the persistent queue.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.Settings"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.Settings`** *(object)*: Settings defines settings for creating a queue.
  - **`Encoding`** *(string)*: .
  - **`ExporterSettings`** *(string)*: .
  - **`Signal`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.asyncQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.asyncQueue`** *(object)*: .
  - **`consumeFunc`** *(string)*: .
  - **`numConsumers`** *(integer)*: .
  - **`stopWG`** *(string)*: .
  - **`unknown`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.blockingDone"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.blockingDone`** *(object)*: .
  - **`ch`** *(string)*: .
  - **`elSize`** *(integer)*: .
  - **`queue`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.cond"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.cond`** *(object)*: cond is equivalent with sync.Cond, but context.Context aware.
...
Also, it requires the caller to hold the c.L during all calls.
  ...
  - **`ch`** *(string)*: .
  - **`waiting`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.disabledQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.disabledQueue`** *(object)*: .
  - **`ShutdownFunc`** *(string)*: .
  - **`StartFunc`** *(string)*: .
  - **`consumeFunc`** *(string)*: .
  - **`size`** *(string)*: .
  - **`sizer`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.indexDone"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.indexDone`** *(object)*: .
  - **`index`** *(integer)*: .
  - **`queue`** *(string)*: .
  - **`size`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.linkedQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.linkedQueue`** *(object)*: .
  - **`head`** *(string)*: .
  - **`tail`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.memoryQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.memoryQueue`** *(object)*: memoryQueue is an in-memory implementation of a Queue.
  - **`StartFunc`** *(string)*: .
  - **`blocking`** *(boolean)*: .
  - **`cap`** *(integer)*: .
  - **`hasMoreElements`** *(string)*: .
  - **`hasMoreSpace`** *(string)*: .
  - **`items`** *(string)*: .
  - **`mu`** *(string)*: .
  - **`size`** *(integer)*: .
  - **`sizer`** *(string)*: .
  - **`stopped`** *(boolean)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.memoryQueueSettings"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.memoryQueueSettings`** *(object)*: memoryQueueSettings defines internal parameters for boundedMemoryQueue creation.
  - **`blocking`** *(boolean)*: .
  - **`capacity`** *(integer)*: .
  - **`sizer`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.node"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.node`** *(object)*: .
  - **`ctx`** *(string)*: .
  - **`data`** *(string)*: .
  - **`next`** *(string)*: .
  - **`size`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.persistentQueue"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.persistentQueue`** *(object)*: persistentQueue provides a persistent queue implementation backed by file storage extension<br>  Write index describes the position at which next item is going to be stored.
Read index describes which item needs to be read next.
When Write index = Read index, no elements are in the queue.<br>  The items currently dispatched by consumers are not deleted until the processing is finished.
Their list is stored under a separate key.<br>  	┌───────file extension-backed queue───────┐
	│                                         │
	│     ┌───┐     ┌───┐ ┌───┐ ┌───┐ ┌───┐   │
	│ n+1 │ n │ ... │ 4 │ │ 3 │ │ 2 │ │ 1 │   │
	│     └───┘     └───┘ └─x─┘ └─|─┘ └─x─┘   │
	...
	└───────────────────────x─────|─────x─────┘
	 ...
	 index          index   x
	                        xxxx deleted.
  - **`client`** *(string)*: .
  - **`currentlyDispatchedItems`** *(array)*: .
    - **Items** *(integer)*
  - **`hasMoreElements`** *(string)*: .
  - **`hasMoreSpace`** *(string)*: .
  - **`isRequestSized`** *(boolean)*: isRequestSized indicates whether the queue is sized by the number of requests.
  - **`logger`** *(string)*: .
  - **`mu`** *(string)*: mu guards everything declared below.
  - **`queueSize`** *(integer)*: .
  - **`readIndex`** *(integer)*: .
  - **`refClient`** *(integer)*: .
  - **`set`** *(string)*: .
  - **`stopped`** *(boolean)*: .
  - **`writeIndex`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.persistentQueueSettings"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.persistentQueueSettings`** *(object)*: .
  - **`blocking`** *(boolean)*: .
  - **`capacity`** *(integer)*: .
  - **`encoding`** *(string)*: .
  - **`set`** *(string)*: .
  ...
  - **`sizer`** *(string)*: .
  - **`storageID`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.requestSizer"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.requestSizer`** *(object)*: requestSizer is a sizer implementation that returns the size of a queue element as one request.
- <a id="definitions/go.opentelemetry.io/collector/exporter/exporterqueue.sizeDone"></a>**`go.opentelemetry.io/collector/exporter/exporterqueue.sizeDone`** *(object)*: .
  - **`queue`** *(string)*: .
  - **`size`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/otlpexporter.Config"></a>**`go.opentelemetry.io/collector/exporter/otlpexporter.Config`** *(object)*: Config defines configuration for OTLP exporter.
  - **`BatcherConfig`** *(string, required)*: Experimental: This configuration is at the early stage of development and may change without backward compatibility
until https://github.com/open-telemetry/opentelemetry-collector/issues/8122 is resolved. Default: `{"Enabled": false, "FlushTimeout": 200000000, "MaxSize": 0, "MaxSizeItems": null, "MinSize": 8192, "MinSizeItems": null, "Sizer": "items"}`.
  - **`ClientConfig`** *(string, required)*: .
  - **`RetryConfig`** *(string, required)*: . Default: `{"Enabled": true, "InitialInterval": 5000000000, "MaxElapsedTime": 300000000000, "MaxInterval": 30000000000, "Multiplier": 1.5, "RandomizationFactor": 0.5}`.
  - **`TimeoutConfig`** *(string, required)*: .
  - **`sending_queue`** *(string, required)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/otlpexporter.baseExporter"></a>**`go.opentelemetry.io/collector/exporter/otlpexporter.baseExporter`** *(object)*: .
  - **`callOptions`** *(array)*: .
    - **Items** *(string)*
  - **`clientConn`** *(string)*: .
  - **`config`** *(string)*: Input configuration.
  - **`logExporter`** *(string)*: .
  - **`metadata`** *(string)*: .
  - **`metricExporter`** *(string)*: .
  - **`profileExporter`** *(string)*: .
  - **`settings`** *(string)*: .
  - **`traceExporter`** *(string)*: gRPC clients and connection.
  - **`userAgent`** *(string)*: Default user-agent header.
- <a id="definitions/go.opentelemetry.io/collector/exporter/otlphttpexporter.Config"></a>**`go.opentelemetry.io/collector/exporter/otlphttpexporter.Config`** *(object)*: Config defines configuration for OTLP/HTTP exporter.
  - **`ClientConfig`** *(string, required)*: .
  - **`Encoding`** *(string, required)*: The encoding to export telemetry (default: "proto"). Default: `"proto"`.
  - **`LogsEndpoint`** *(string, required)*: The URL to send logs to. If omitted the Endpoint + "/v1/logs" will be used. Default: `""`.
  - **`MetricsEndpoint`** *(string, required)*: The URL to send metrics to. If omitted the Endpoint + "/v1/metrics" will be used. Default: `""`.
  - **`RetryConfig`** *(string, required)*: . Default: `{"Enabled": true, "InitialInterval": 5000000000, "MaxElapsedTime": 300000000000, "MaxInterval": 30000000000, "Multiplier": 1.5, "RandomizationFactor": 0.5}`.
  - **`TracesEndpoint`** *(string, required)*: The URL to send traces to. If omitted the Endpoint + "/v1/traces" will be used. Default: `""`.
  - **`sending_queue`** *(string, required)*: .
- <a id="definitions/go.opentelemetry.io/collector/exporter/otlphttpexporter.baseExporter"></a>**`go.opentelemetry.io/collector/exporter/otlphttpexporter.baseExporter`** *(object)*: .
  - **`client`** *(string)*: .
  - **`config`** *(string)*: Input configuration.
  - **`logger`** *(string)*: .
  - **`logsURL`** *(string)*: .
  ...
  - **`tracesURL`** *(string)*: .
  - **`userAgent`** *(string)*: Default user-agent header.
- <a id="definitions/go.opentelemetry.io/collector/extension/zpagesextension.Config"></a>**`go.opentelemetry.io/collector/extension/zpagesextension.Config`** *(object)*: Config has the configuration for the extension enabling the zPages extension.
  - **`Expvar`** *(string, required)*: . Default: `{"Enabled": false}`.
  - **`ServerConfig`** *(string, required)*: .
- <a id="definitions/go.opentelemetry.io/collector/extension/zpagesextension.ExpvarConfig"></a>**`go.opentelemetry.io/collector/extension/zpagesextension.ExpvarConfig`** *(object)*: ExpvarConfig has the configuration for the expvar service.
  - **`Enabled`** *(boolean, required)*: Enabled indicates whether to enable expvar service.
(default = false).
- <a id="definitions/go.opentelemetry.io/collector/extension/zpagesextension.zpagesExtension"></a>**`go.opentelemetry.io/collector/extension/zpagesextension.zpagesExtension`** *(object)*: .
  - **`config`** *(string)*: .
  - **`server`** *(string)*: .
  - **`stopCh`** *(string)*: .
  - **`telemetry`** *(string)*: .
  - **`zpagesSpanProcessor`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/internal/memorylimiter.Config"></a>**`go.opentelemetry.io/collector/internal/memorylimiter.Config`** *(object)*: Config defines configuration for memory memoryLimiter processor.
  - **`CheckInterval`** *(string, required)*: CheckInterval is the time between measurements of memory usage for the
purposes of avoiding going over the limits. Defaults to zero, so no
checks will be performed. Default: `0`.
  - **`MemoryLimitMiB`** *(integer, required)*: MemoryLimitMiB is the maximum amount of memory, in MiB, targeted to be
allocated by the process. Default: `0`.
  - **`MemoryLimitPercentage`** *(integer, required)*: MemoryLimitPercentage is the maximum amount of memory, in %, targeted to be
allocated by the process. The fixed memory settings MemoryLimitMiB has a higher precedence. Default: `0`.
  - **`MemorySpikeLimitMiB`** *(integer, required)*: MemorySpikeLimitMiB is the maximum, in MiB, spike expected between the
measurements of memory usage. Default: `0`.
  - **`MemorySpikePercentage`** *(integer, required)*: MemorySpikePercentage is the maximum, in percents against the total memory,
spike expected between the measurements of memory usage. Default: `0`.
  - **`MinGCIntervalWhenHardLimited`** *(string, required)*: MinGCIntervalWhenHardLimited minimum interval between forced GC when in hard (=limit_mib) limited mode.
Zero value means no minimum interval.
GCs is a CPU-heavy operation and executing it too frequently may affect the recovery capabilities of the collector. Default: `0`.
  - **`MinGCIntervalWhenSoftLimited`** *(string, required)*: MinGCIntervalWhenSoftLimited minimum interval between forced GC when in soft (=limit_mib - spike_limit_mib) limited mode.
Zero value means no minimum interval.
GCs is a CPU-heavy operation and executing it too frequently may affect the recovery capabilities of the collector. Default: `10000000000`.
- <a id="definitions/go.opentelemetry.io/collector/internal/memorylimiter.MemoryLimiter"></a>**`go.opentelemetry.io/collector/internal/memorylimiter.MemoryLimiter`** *(object)*: MemoryLimiter is used to prevent out of memory situations on the collector.
  - **`closed`** *(string)*: .
  - **`lastGCDone`** *(string)*: .
  - **`logger`** *(string)*: Fields used for logging.
  - **`memCheckWait`** *(string)*: .
  - **`minGCIntervalWhenHardLimited`** *(string)*: .
  - **`minGCIntervalWhenSoftLimited`** *(string)*: .
  - **`mustRefuse`** *(string)*: mustRefuse is used to indicate when data should be refused.
  - **`readMemStatsFn`** *(string)*: The functions to read the mem values and run GC are set as a reference to help with
testing different values.
  - **`refCounter`** *(integer)*: .
  - **`refCounterLock`** *(string)*: .
  - **`runGCFn`** *(string)*: .
  - **`ticker`** *(string)*: .
  - **`usageChecker`** *(string)*: .
  - **`waitGroup`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/internal/memorylimiter.memUsageChecker"></a>**`go.opentelemetry.io/collector/internal/memorylimiter.memUsageChecker`** *(object)*: .
  - **`memAllocLimit`** *(integer)*: .
  - **`memSpikeLimit`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.Config"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.Config`** *(object)*: Config defines configuration for batch processor.
  - **`MetadataCardinalityLimit`** *(integer, required)*: MetadataCardinalityLimit indicates the maximum number of
batcher instances that will be created through a distinct
combination of MetadataKeys. Default: `1000`.
  - **`MetadataKeys`** *(array, required)*: MetadataKeys is a list of client.Metadata keys that will be
...
combination of values for the listed metadata keys.<br>    Empty value and unset metadata are treated as distinct cases.<br>    Entries are case-insensitive.  Duplicated entries will
trigger a validation error. Default: `null`.
    - **Items** *(string)*
  - **`SendBatchMaxSize`** *(integer, required)*: SendBatchMaxSize is the maximum size of a batch. It must be larger than SendBatchSize.
Larger batches are split into smaller units.
Default value is 0, that means no maximum size. Default: `0`.
  - **`SendBatchSize`** *(integer, required)*: SendBatchSize is the size of a batch which after hit, will trigger it to be sent.
When this is set to zero, the batch size is ignored and data will be sent immediately
subject to only send_batch_max_size. Default: `8192`.
  - **`Timeout`** *(string, required)*: Timeout sets the time after which a batch will be sent regardless of size.
When this is set to zero, batched data will be sent immediately. Default: `200000000`.
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.batchLogs"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.batchLogs`** *(object)*: .
  - **`logCount`** *(integer)*: .
  - **`logData`** *(string)*: .
  - **`nextConsumer`** *(string)*: .
  - **`sizer`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.batchMetrics"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.batchMetrics`** *(object)*: .
  - **`dataPointCount`** *(integer)*: .
  - **`metricData`** *(string)*: .
  - **`nextConsumer`** *(string)*: .
  - **`sizer`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.batchProcessor"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.batchProcessor`** *(object)*: batch_processor is a component that accepts spans and metrics, places them
into batches and sends downstream.<br>  batch_processor implements consumer.Traces and consumer.Metrics<br>  Batches are sent out with any of the following conditions:
- batch size reaches cfg.SendBatchSize
- cfg.Timeout is elapsed since the timestamp when the previous batch was sent out.
  - **`batchFunc`** *(string)*: batchFunc is a factory for new batch objects corresponding
with the appropriate signal.
  - **`batcher`** *(string)*: batcher will be either *singletonBatcher or *multiBatcher.
  - **`goroutines`** *(string)*: .
  - **`logger`** *(string)*: .
  - **`sendBatchMaxSize`** *(integer)*: .
  - **`sendBatchSize`** *(integer)*: .
  - **`shutdownC`** *(string)*: .
  - **`telemetry`** *(string)*: .
  - **`timeout`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.batchProcessorTelemetry"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.batchProcessorTelemetry`** *(object)*: .
  - **`exportCtx`** *(string)*: .
  - **`processorAttr`** *(string)*: .
  - **`telemetryBuilder`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.batchTraces"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.batchTraces`** *(object)*: .
  - **`nextConsumer`** *(string)*: .
  - **`sizer`** *(string)*: .
  - **`spanCount`** *(integer)*: .
  - **`traceData`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.logsBatchProcessor"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.logsBatchProcessor`** *(object)*: .
  - **`unknown`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.metricsBatchProcessor"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.metricsBatchProcessor`** *(object)*: .
  - **`unknown`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.multiShardBatcher"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.multiShardBatcher`** *(object)*: multiShardBatcher is used when metadataKeys is not empty.
  - **`batchers`** *(string)*: .
  - **`lock`** *(string)*: Guards the size and the storing logic to ensure no more than limit items are stored.
If we are willing to allow "some" extra items than the limit this can be removed and size can be made atomic.
  - **`metadataKeys`** *(array)*: metadataKeys is the configured list of metadata keys.  When
...
triggers a new batcher, counted in `goroutines`.
    - **Items** *(string)*
  - **`metadataLimit`** *(integer)*: metadataLimit is the limiting size of the batchers map.
  - **`processor`** *(string)*: .
  - **`size`** *(integer)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.shard"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.shard`** *(object)*: shard is a single instance of the batch logic.  When metadata
keys are in use, one of these is created per distinct combination
of values.
  - **`batch`** *(string)*: batch is an in-flight data item containing one of the
underlying data types.
  - **`exportCtx`** *(string)*: exportCtx is a context with the metadata key-values
corresponding with this shard set.
  - **`newItem`** *(string)*: newItem is used to receive data items from producers.
  - **`processor`** *(string)*: processor refers to this processor, for access to common
configuration.
  - **`timer`** *(string)*: timer informs the shard send a batch.
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.singleShardBatcher"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.singleShardBatcher`** *(object)*: singleShardBatcher is used when metadataKeys is empty, to avoid the
additional lock and map operations used in multiBatcher.
  - **`processor`** *(string)*: .
  - **`single`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/processor/batchprocessor.tracesBatchProcessor"></a>**`go.opentelemetry.io/collector/processor/batchprocessor.tracesBatchProcessor`** *(object)*: .
  - **`unknown`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.Config"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.Config`** *(object)*: Config defines configuration for OTLP receiver.
  - **`protocols`** *(string, required)*: Protocols is the configuration for the supported protocols, currently gRPC and HTTP (Proto and JSON).
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.HTTPConfig"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.HTTPConfig`** *(object)*: .
  - **`LogsURLPath`** *(string)*: The URL path to receive logs on. If omitted "/v1/logs" will be used.
  - **`MetricsURLPath`** *(string)*: The URL path to receive metrics on. If omitted "/v1/metrics" will be used.
  - **`ServerConfig`** *(string, required)*: .
  - **`TracesURLPath`** *(string)*: The URL path to receive traces on. If omitted "/v1/traces" will be used.
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.Protocols"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.Protocols`** *(object)*: Protocols is the configuration for the supported protocols.
  - **`GRPC`** *(string, required)*: .
  - **`HTTP`** *(string, required)*: .
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.jsonEncoder"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.jsonEncoder`** *(object)*: .
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.otlpReceiver"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.otlpReceiver`** *(object)*: otlpReceiver is the type that exposes Trace and Metrics reception.
  - **`cfg`** *(string)*: .
  - **`nextLogs`** *(string)*: .
  - **`nextMetrics`** *(string)*: .
  - **`nextProfiles`** *(string)*: .
  ...
  - **`settings`** *(string)*: .
  - **`shutdownWG`** *(string)*: .
- <a id="definitions/go.opentelemetry.io/collector/receiver/otlpreceiver.protoEncoder"></a>**`go.opentelemetry.io/collector/receiver/otlpreceiver.protoEncoder`** *(object)*: .
