...
func TestBindFlags(t *testing.T) {
	...
	require.NotNil(t, c.Indices.Spans.Priority)
	assert.EqualValues(t, 300, *c.Indices.Spans.Priority)
	require.NotNil(t, c.Indices.Services.Priority)
	assert.EqualValues(t, 301, *c.Indices.Services.Priority)
	require.NotNil(t, c.Indices.Dependencies.Priority)
	assert.EqualValues(t, 302, *c.Indices.Dependencies.Priority)
	require.NotNil(t, c.Indices.Sampling.Priority)
