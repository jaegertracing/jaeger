...
import (
	...
	"github.com/jaegertracing/jaeger/cmd/proxy/app/mocks"
...
func TestRegisterStaticHandlerPanic(t *testing.T) {
	...
	assert.Panics(t, func() {
		RegisterStaticHandler(mux.NewRouter(), logger, &ProxyOptions{StaticAssets: "/foo/bar"})
	})
...
func TestRegisterStaticHandler(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run("basePath="+testCase.basePath, func(t *testing.T) {
			...
			RegisterStaticHandler(r, logger, &ProxyOptions{
