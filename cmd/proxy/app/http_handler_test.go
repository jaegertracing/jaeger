...
func initializeTestServerWithHandler(queryOptions proxysvc.ProxyServiceOptions, options ...HandlerOption) (*httptest.Server, *spanstoremocks.Reader, *depsmocks.Reader, *APIHandler) {
...
func initializeTestServerWithOptions(queryOptions proxysvc.ProxyServiceOptions, options ...HandlerOption) (*httptest.Server, *spanstoremocks.Reader, *depsmocks.Reader, *APIHandler) {
	readStorage := &spanstoremocks.Reader{}
	dependencyStorage := &depsmocks.Reader{}
	qs := proxysvc.NewProxyService(queryOptions, zap.NewNop())
	r := NewRouter()
...
func initializeTestServer(options ...HandlerOption) (*httptest.Server, *spanstoremocks.Reader, *depsmocks.Reader) {
	https, sr, dr, _ := initializeTestServerWithHandler(proxysvc.ProxyServiceOptions{}, options...)
	return https, sr, dr
}
...
func withTestServer(t *testing.T, doTest func(s *testServer), queryOptions proxysvc.ProxyServiceOptions, options ...HandlerOption) {
...
func TestLogOnServerError(t *testing.T) {
	...
	qs := proxysvc.NewProxyService(proxysvc.ProxyServiceOptions{}, zap.NewNop())
...
func TestSearchByTraceIDSuccessWithArchive(t *testing.T) {
	...
	server, readMock, _, _ := initializeTestServerWithOptions(proxysvc.ProxyServiceOptions{
