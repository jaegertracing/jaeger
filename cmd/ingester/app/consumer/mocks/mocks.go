...
// Key provides a mock function for the type Message
func (_mock *Message) Key() []byte {
	ret := _mock.Called()
...
func (_c *Message_Key_Call) Return(bytes []byte) *Message_Key_Call {
...
// Offset provides a mock function for the type Message
func (_mock *Message) Offset() int64 {
	ret := _mock.Called()
...
func (_c *Message_Offset_Call) Return(n int64) *Message_Offset_Call {
	_c.Call.Return(n)
	return _c
}
...
// Partition provides a mock function for the type Message
func (_mock *Message) Partition() int32 {
	ret := _mock.Called()
...
func (_c *Message_Partition_Call) Return(n int32) *Message_Partition_Call {
	_c.Call.Return(n)
	return _c
}
...
// Topic provides a mock function for the type Message
func (_mock *Message) Topic() string {
	ret := _mock.Called()
...
func (_c *Message_Topic_Call) Return(s string) *Message_Topic_Call {
	_c.Call.Return(s)
	return _c
}
...
// Value provides a mock function for the type Message
func (_mock *Message) Value() []byte {
	ret := _mock.Called()
...
func (_c *Message_Value_Call) Return(bytes []byte) *Message_Value_Call {
	_c.Call.Return(bytes)
	return _c
}
