...
func (_m *Consumer) Partitions() <-chan sarama.ConsumerGroup {
	ret := _m.Called()

	var r0 <-chan sarama.ConsumerGroup
	if rf, ok := ret.Get(0).(func() <-chan sarama.ConsumerGroup); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan sarama.ConsumerGroup)
		}
	}
