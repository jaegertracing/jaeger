...
#
# Single-command launcher for the OpenRouter AI sidecar. Use via:
#
...
#
# This script:
#   1. Runs the preflight check (verifies OPENROUTER_API_KEY and OPENROUTER_MODEL).
...
ai::log "starting OpenRouter sidecar (model=$OPENROUTER_MODEL)…"
cd "$HERE"
